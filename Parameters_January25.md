...
### 31 January 2025 - A Lorentz gas with oscillating obstacles of two different masses in strong magnetic field ###
...
### 30 January 2025 - Exciting standing waves in a hexagon ###
...
```
    ...
    {
        angle = DPI*(double)k/(double)N_SOURCES + APOLY*DPI;
...
### 29 January 2025 - A lighthouse beam in a square ###
...
#define LAMBDA 1.41 	/* parameter controlling shape of domain */
...
#define PRINT_TRAJECTORY_ANGLE 0    /* set to 1 to print angle of trajectory 0 */
#define PRINT_TRAJECTORY_SLOPE 1    /* set to 1 to print slope of trajectory 0 */
...
### 28 January 2025 - A Lorentz gas with oscillating obstacles on a square lattice in strong magnetic field ###
...
#define OBSTACLE_MASS 100.0       /* mass of obstacles, if oscillating */
#define KSPRING_OBSTACLE_OSC 5.0e5   /* spring constant for oscillating obstacles */
#define KSPRING_OBSTACLE_COUPLE 5.0e4   /* spring constant for coupled obstacles */
#define OBSTACLE_HARDCORE 1         /* set to 1 to add "hard core" repulsion between obstacles */
#define KSPRING_OBSTACLE_HARDCORE 1.0e11     /* spring constant for obstacle hard core repulsion */
#define KCOULOMB_OBSTACLE 1000.0   /* Coulomb force constant for charged obstacles */
#define EFIELD_REGION 0          /* space-dependent magnetic field (0 for constant) */
...
### 27 January 2025 - Two pulsing sources in a Tokarsky room ###
...
```
    ...
    wave_source_x[0] = -2.0*ratio;
    wave_source_y[0] = 0.0;
    wave_source_x[1] = 2.0*ratio;
    wave_source_y[1] = 0.0;
    for (source = 0; source < N_SOURCES; source++)
    {
        source_shift[source] = 0;
...
### 26 January 2025 - A lighthouse beam in a rectangle isosceles triangle with smaller absorbers ###
...
#define PLOT_NMAX 410   /* max length on length plot */
#define LMAX 0.01       /* minimal segment length triggering resampling */ 
#define DMIN 0.02       /* minimal distance to boundary for triggering resampling */ 
#define CYCLE 0         /* set to 1 for closed curve (start in all directions) */
#define SHOWTRAILS 0    /* set to 1 to keep trails of the particles */
...
### 25 January 2025 - A Lorentz gas with oscillating obstacles on a hex lattice in strong magnetic field ###
...
#define COUPLE_OBSTACLES 1      /* set to 1 to couple obstacles to neighbours */
#define OBSTACLE_PISC_DISTANCE 0.08  /* minimal distance in Poisson disc process for obstacles, controls density of obstacles */
#define OBSTACLE_COUPLING_DIST 0.15  /* max distance of coupled obstacles */
#define NMAX_OBSTACLE_NEIGHBOURS 8  /* max number of obstacle neighbours */
#define NMAX_OBSTACLE_PINNED 6      /* max number of neighbours to be pinned */
#define OBSTACLE_PINNING_TYPE 0     /* type of obstacle pinning, see OP_ in global_ljones */
#define BDRY_PINNING_STEP 4         /* interval between pinned obstacles on boundary */
...
#define NVID 3500          /* number of iterations between images displayed on screen */
#define NSEG 25          /* number of segments of boundary of circles */
#define INITIAL_TIME 0     /* time after which to start saving frames */
#define OBSTACLE_INITIAL_TIME 0     /* time after which to start moving obstacle */
#define BOUNDARY_WIDTH 1    /* width of particle boundary */
...
#define ERATIO 0.995          /* ratio for time-averaging in P_EMEAN color scheme */
#define DRATIO 0.999          /* ratio for time-averaging in P_DIRECT_EMEAN color scheme */
#define OBSTACLE_AREA_SHADE_FACTOR 300.0     /* controls sensitivity of triangle shade for option FILL_OBSTACLE_TRIANGLES */
...
#define OBSTACLE_CHARGE 3.0     /* charge of obstacles */
#define OBSTACLE_MASS 100.0       /* mass of obstacles, if oscillating */
#define KSPRING_OBSTACLE_OSC 1.0e6   /* spring constant for oscillating obstacles */
#define KSPRING_OBSTACLE_COUPLE 5.0e5   /* spring constant for coupled obstacles */
#define OBSTACLE_HARDCORE 1         /* set to 1 to add "hard core" repulsion between obstacles */
#define KSPRING_OBSTACLE_HARDCORE 1.0e11     /* spring constant for obstacle hard core repulsion */
#define KCOULOMB_OBSTACLE 1000.0   /* Coulomb force constant for charged obstacles */
#define EFIELD_REGION 0          /* space-dependent magnetic field (0 for constant) */
...
### 24 January 2025 - Two pulsing sources in homophonic drums ###
...
```
    ...
    wave_source_x[0] = startleft[0];
    wave_source_y[0] = startleft[1];
    wave_source_x[1] = startright[0];
    wave_source_y[1] = startright[1];
    homophonic_initial_point(1.5, 2.05, -1.0, 0.04, startleft, startright);
    wave_source_x[2] = startleft[0];
    wave_source_y[2] = startleft[1];
    wave_source_x[3] = startright[0];
    wave_source_y[3] = startright[1];
    for (source = 0; source < N_SOURCES; source++)
    {
        source_shift[source] = 0;
        if ((ADD_OSCILLATING_SOURCE)&&(i%(OSCILLATING_SOURCE_PERIOD) == source_shift[source])&&(i<MAX_PULSING_TIME))
...
#define VSHIFT_AMPLITUDE -0.5   /* additional shift for wave amplitude */
#define VSCALE_AMPLITUDE 0.2    /* additional scaling factor for wave amplitude */
#define E_SCALE 6.0        /* scaling factor for energy representation */
#define LOG_SCALE 0.75     /* scaling factor for energy log representation */
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
#define FLUX_SCALE 250.0    /* scaling factor for energy flux represtnation */
...
### 23 January 2025 - A lighthouse beam in a rectangle isosceles triangle ###
...
### 22 January 2025 - A Lorentz gas with small oscillating Poisson obstacles in a strong magnetic field ###
...
#define OBSTACLE_CHARGE 3.0     /* charge of obstacles */
#define OBSTACLE_MASS 100.0       /* mass of obstacles, if oscillating */
#define KSPRING_OBSTACLE_OSC 5.0e6   /* spring constant for oscillating obstacles */
#define KSPRING_OBSTACLE_COUPLE 2.5e6   /* spring constant for coupled obstacles */
#define OBSTACLE_HARDCORE 1         /* set to 1 to add "hard core" repulsion between obstacles */
#define KSPRING_OBSTACLE_HARDCORE 1.0e11     /* spring constant for obstacle hard core repulsion */
#define KCOULOMB_OBSTACLE 1000.0   /* Coulomb force constant for charged obstacles */
#define EFIELD_REGION 0          /* space-dependent magnetic field (0 for constant) */
...
### 21 January 2025 - Pulsing sources in homophonic drums ###
...
#define VSHIFT_AMPLITUDE -0.5   /* additional shift for wave amplitude */
#define VSCALE_AMPLITUDE 0.2    /* additional scaling factor for wave amplitude */
#define E_SCALE 8.0        /* scaling factor for energy representation */
#define LOG_SCALE 0.75     /* scaling factor for energy log representation */
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
#define FLUX_SCALE 250.0    /* scaling factor for energy flux represtnation */
...
### 20 January 2025 - Billiard in a rectangle isosceles triangle ###

**Program:** `particle_billiard.c` 

**Initial condition in function `animation()`:** `init_drop_config(1.0, -1.0, 1.5*PID, PI, configs);` 
...
### 19 January 2025 - A Lorentz gas with oscillating Poisson obstacles in a strong magnetic field ###
...
### 18 January 2025 - Pulsing sources in isospectral drums ###
...
```
    isospectral_initial_point(0.1, 0.0, startleft, startright);
    init_wave_flat(phi, psi, xy_in);
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 33    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 2                     /* number of sources, for option draw_sources */
#define ALTERNATE_SOURCE_PHASES 0       /* set to 1 to alternate initial phases of sources */
#define MAX_PULSING_TIME 1500            /* max time for adding pulses */
...
### 17 January 2025 - Who is the winner? Charged particles racing through a maze with a magnetic field ###
...
#define OBSTACLE_PATTERN 6      /* pattern of obstacles, see list in global_ljones.c */
#define RATTLE_OBSTACLES 0      /* set to 1 to rattle obstacles (for pattern O_SIEVE_B) */
#define OSCILLATE_OBSTACLES 0   /* set to 1 to make obstacles oscillate */ 
...
#define ADD_EFIELD 1     /* set to 1 to add an electric field */
#define EFIELD 0.0       /* value of electric field */
#define EFIELD_Y 3000.0       /* value of electric field */
#define ADD_BFIELD 1     /* set to 1 to add a magnetic field */
...
#define KSPRING_OBSTACLE_HARDCORE 1.0e11     /* spring constant for obstacle hard core repulsion */
#define KCOULOMB_OBSTACLE 1000.0   /* Coulomb force constant for charged obstacles */
#define EFIELD_REGION 2          /* space-dependent magnetic field (0 for constant) */
#define BFIELD_REGION 0          /* space-dependent magnetic field (0 for constant) */
...
#define N_ADD_PARTICLES 1  /* number of particles to add */
#define FINAL_NOADD_PERIOD 2900  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
#define TRACER_STEPS 5           /* number of tracer steps recorded between images */
#define TRAJECTORY_LENGTH 40000    /* length of recorded trajectory */
#define TRACER_LUM_FACTOR 10.0     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
#define TRAJECTORY_WIDTH 2        /* width of tracer particle trajectory */
...
### 16 January 2025 - A Lorentz gas with Poisson obstacles on a strong magnetic field ###
...
#define OSCILLATE_OBSTACLES 0   /* set to 1 to make obstacles oscillate */ 
#define COUPLE_OBSTACLES 0      /* set to 1 to couple obstacles to neighbours */
#define OBSTACLE_PISC_DISTANCE 0.15  /* minimal distance in Poisson disc process for obstacles, controls density of obstacles */
#define OBSTACLE_COUPLING_DIST 0.09  /* max distance of coupled obstacles */
#define NMAX_OBSTACLE_NEIGHBOURS 8  /* max number of obstacle neighbours */
#define NMAX_OBSTACLE_PINNED 3      /* max number of neighbours to be pinned */
#define OBSTACLE_PINNING_TYPE 5     /* type of obstacle pinning, see OP_ in global_ljones */
...
### 15 January 2025 - Waves in a heptafoloid ###
...
### 14 January 2025 - Solving a 16 by 16 maze using a magnetic field ###
...
#define ALTITUDE_LINES 0    /* set to 1 to add horizontal lines to show altitude */
#define COLOR_SEG_GROUPS 0  /* set to 1 to collor segment groups differently */
#define N_PARTICLE_COLORS 10   /* number of colors for P_NUMBER color scheme */
#define INITIAL_POS_TYPE 0     /* type of initial position dependence */
#define ERATIO 0.995          /* ratio for time-averaging in P_EMEAN color scheme */
#define DRATIO 0.999          /* ratio for time-averaging in P_DIRECT_EMEAN color scheme */
#define OBSTACLE_AREA_SHADE_FACTOR 160.0     /* controls sensitivity of triangle shade for option FILL_OBSTACLE_TRIANGLES */
...
### 13 January 2025 - 3D representation of the 2023 Dickson fjord seiche in Greenland - Zoom on Dickson fjord ###
...
### 12 January 2025 - Solving a maze using a magnetic field - Maze with longer path through ###
...
#define ADDXMAX -1.8	  /* x interval for adding particles */
#define ADDYMIN 0.0
#define ADDYMAX 0.35      /* y interval for adding particles */
#define ADDRMIN 4.75 
#define ADDRMAX 6.0     /* r interval for adding particles */
...
#define EFIELD_Y 3000.0       /* value of electric field */
#define ADD_BFIELD 1     /* set to 1 to add a magnetic field */
#define BFIELD 1500.0      /* value of magnetic field */
#define CHARGE 1.0      /* charge of particles of first type */
#define CHARGE_B 1.0     /* charge of particles of second type */
#define INCREASE_E 0     /* set to 1 to increase electric field */
#define EFIELD_FACTOR 5000000.0    /* factor by which to increase electric field */
...
### 11 January 2025 - Simulation of the 2023 Dickson fjord seiche in Greenland - zoom on Dickson fjord ###
...
#define N_SOURCES 1                     /* number of sources, for option draw_sources */
#define ALTERNATE_SOURCE_PHASES 0       /* set to 1 to alternate initial phases of sources */
#define MAX_PULSING_TIME 200            /* max time for adding pulses */
...
### 10 January 2025 - An inefficient way of “solving” a maze: Using a magnetic field ###
...
### 09 January 2025 - 3D representation of the 2023 Dickson fjord seiche in Greenland ###
...
#define B_DOMAIN_B 20       /* second domain shape, for comparisons */
#define CIRCLE_PATTERN_B 0  /* second pattern of circles or polygons */
#define IMAGE_FILE 4        /* for option D_IMAGE */
...
### 08 January 2025 - A Lorentz gas in strong magnetic field and weaker electric field ###
...
### 07 January 2025 - 3D representation of waves in an epicycloid with four cusps ###
...
#define PHASE_SHIFT 0.0      /* shift of phase in color scheme P_3D_PHASE */
#define ATTENUATION 0.0     /* exponential attenuation coefficient of contrast with time */
#define E_SCALE 180.0       /* scaling factor for energy representation */
#define LOG_SCALE 1.5       /* scaling factor for energy log representation */
#define LOG_SHIFT 0.25      /* shift of colors on log scale */
#define LOG_ENERGY_FLOOR -10.0    /* floor value for log of (total) energy */
#define LOG_MEAN_ENERGY_SHIFT 1.0   /* additional shift for log of mean energy */
...
### 06 January 2025 - Trying to trap an electron at smaller electric field ###
...
#define TRACER_PARTICLE 1   /* set to 1 to have a tracer particle */
#define N_TRACER_PARTICLES 25    /* number of tracer particles */
#define TRACER_STEPS 5           /* number of tracer steps recorded between images */
#define TRAJECTORY_LENGTH 40000    /* length of recorded trajectory */
#define TRACER_LUM_FACTOR 100.0     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
...
### 05 January 2025 - Simulation of the 2023 Dickson fjord seiche in Greenland ###
...
### 04 January 2025 - Ejecting an atom from a crystal ###
...
#define RECOUPLE_OBSTACLES 1        /* set to 1 to reset obstacle coupling */
#define OBSTACLE_RECOUPLE_TYPE 1    /* algorithm for recoupling, see OR_ in global_ljones */
#define OBSTACLE_RECOUPLE_TIME 5    /* time between obstacle recouplings */
#define UNCOUPLE_MAXLENGTH 1.2      /* length at which bonds decouple */
#define COUPLE_MINLENGTH 0.9        /* length at which bonds decouple */
...
### 03 January 2025 - Waves in an epicycloid with five cusps ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        ...
        wave_source_x[source] = 1.4*LAMBDA*cos(angle);
        wave_source_y[source] = 1.4*LAMBDA*sin(angle);
        source_shift[source] = 0;
        if ((ADD_OSCILLATING_SOURCE)&&(i%(OSCILLATING_SOURCE_PERIOD) == source_shift[source])&&(i<MAX_PULSING_TIME))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
...
#define INITIAL_AMP 0.8             /* amplitude of initial condition */
#define INITIAL_VARIANCE 0.00005    /* variance of initial condition */
#define INITIAL_WAVELENGTH  0.025   /* wavelength of initial condition */
...
### 02 January 2025 - Can a local repulsive potential trap an electron? ###
...
#define ADDXMAX -1.9	/* x interval for adding particles */
#define ADDYMIN -0.3
#define ADDYMAX 0.3	/* y interval for adding particles */
#define ADDRMIN 4.75 
#define ADDRMAX 6.0     /* r interval for adding particles */
...
#define ADD_EFIELD 1     /* set to 1 to add an electric field */
#define EFIELD 0.0       /* value of electric field */
#define EFIELD_Y 5000.0       /* value of electric field */
#define ADD_BFIELD 1     /* set to 1 to add a magnetic field */
#define BFIELD 1500.0      /* value of magnetic field */
#define CHARGE 1.0      /* charge of particles of first type */
#define CHARGE_B 1.0     /* charge of particles of second type */
...
#define ADD_PERIOD 700      /* time interval between adding further particles */
#define N_ADD_PARTICLES 1  /* number of particles to add */
#define FINAL_NOADD_PERIOD 500  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
### 01 January 2025 - New year fireworks ###
...
```
    ...
    wave_source_y[0] = 0.75;
    wave_source_y[1] = 0.75;
    wave_source_y[2] = 0.25;
    wave_source_y[3] = 0.25;
    wave_source_y[4] = -0.85;
    wave_source_y[5] = -0.85;
    wave_source_y[6] = -0.9;
    ...
    if ((ADD_OSCILLATING_SOURCE)&&(i%(OSCILLATING_SOURCE_PERIOD) == source_shift[source])&&(i >= 1000)&&(i< 1000 + MAX_PULSING_TIME))
    {
        if (ALTERNATE_OSCILLATING_SOURCE) sign[0] = -sign[0];
        add_circular_wave(-sign[0]*INITIAL_AMP, 0.0, -0.75, phi, psi, xy_in);
    }
```
...
#define CIRCLE_PATTERN 202   /* pattern of circles or polygons, see list in global_pdes.c */
#define IMAGE_FILE 3        /* for option D_IMAGE */
...
#define COURANTB 0.02      /* Courant number in medium B */
#define GAMMA 1.0e-4       /* damping factor in wave equation */
#define GAMMAB 0.0         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
#define GAMMA_TOPBOT 1.0e-7     /* damping factor on boundary */
#define KAPPA 0.0           /* "elasticity" term enforcing oscillations */
