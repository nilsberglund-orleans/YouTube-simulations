...
### 31 March 24 - Do aggregating pentagons form a quasicrystal? ###
...
#define TYPE_PROPORTION 0.667 /* proportion of particles of first type */
...
#define INTERACTION_B 3     /* particle interaction for second type of particle, see list in global_ljones.c */
...
#define DAMPING_ROT 1000.0      /* dampint coefficient for rotation of particles */
...
#define KTORQUE_PAIRS -5.0e8    /* constant for angular coupling in pair interaction */
#define NPARTNERS 20         /* number of partners of particles */
...
### 30 March 24 - Two planar waves interfering in a Ritchey-Chrétien telescope ###
...
#define B_DOMAIN 751        /* choice of domain shape, see list in global_pdes.c */
...
#define MU 0.17             /* parameter controlling the dimensions of domain */
...
#define OSCIL_LEFT_YSHIFT 20.0   /* y-dependence of left oscillation (for non-horizontal waves) */
...
### 29 March 24 - Eight interacing vortices on a sphere ###
...
```
    init_vortex_state_sphere(0, 1.0, 0.0, PID + 0.3, 0.15, 0.3, phi, xy_in, wsphere);
    init_vortex_state_sphere(1, -1.0, PI/4.0, PID - 0.3, 0.15, 0.3, phi, xy_in, wsphere);
    init_vortex_state_sphere(1, 1.0, PID, PID + 0.3, 0.15, 0.3, phi, xy_in, wsphere);
    init_vortex_state_sphere(1, -1.0, 3.0*PI/4, PID - 0.3, 0.15, 0.3, phi, xy_in, wsphere);
    init_vortex_state_sphere(1, 1.0, PI, PID + 0.3, 0.15, 0.3, phi, xy_in, wsphere);
    init_vortex_state_sphere(1, -1.0, 5.0*PI/4.0, PID - 0.3, 0.15, 0.3, phi, xy_in, wsphere);
    init_vortex_state_sphere(1, 1.0, 3.0*PID, PID + 0.3, 0.15, 0.3, phi, xy_in, wsphere);
    init_vortex_state_sphere(1, -1.0, 7.0*PI/4.0, PID - 0.3, 0.15, 0.3, phi, xy_in, wsphere);
```
...
#define SMOOTHEN_PERIOD 24      /* period between smoothenings */
#define SMOOTH_FACTOR 0.005     /* factor by which to smoothen */
...
### 28 March 24 - Aggregating pentagonal and triangular molecules in an electric field ###
...
#define RD_TYPES 2              /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 99        /* initial condition of particles */
#define REACTION_DIST 4.5         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0001  /* probability controlling dissociation reaction */ 
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define EXOTHERMIC 0            /* set to 1 to make reaction exo/endothermic */
...
### 27 March 24 - A gradient index lens ###
...
### 26 March 24 - A shear flow on a sphere (short version) ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_shear_flow_sphere(1.0, 0.25, 0.25, 6, 6, 0.75, phi, xy_in, wsphere);`
...
#define NVID 140           /* number of iterations between images displayed on screen */
#define ACCELERATION_FACTOR 1.0 /* factor by which to increase NVID in course of simulation */
#define DT_ACCELERATION_FACTOR 1.0 /* factor by which to increase time step in course of simulation  */
#define MAX_DT 0.024     /* maximal value of integration step */
#define NSEG 999         /* number of segments of boundary */
...
#define SCALE 0          /* set to 1 to adjust color scheme to variance of field */
#define SLOPE 1.0        /* sensitivity of color on wave amplitude */
#define VSCALE_AMPLITUDE 0.25      /* additional scaling factor for color scheme P_3D_AMPLITUDE */
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
#define CURL_SCALE 0.000015   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define SLOPE_SCHROD_LUM 100.0       /* sensitivity of luminosity on module, for color scheme Z_ARGUMENT */
...
### 25 March 24 - Trying to form a foam with aggregating “quadripod” molecules ###
...
### 24 March 24 - A planar wave arriving at an angle in a Ritchey-Chrétien telescope ###
...
### 23 March 24 - A shear flow with 7 layers on the sphere ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_shear_flow_sphere(1.0, 0.25, 0.25, 8, 7, 0.75, phi, xy_in, wsphere);`
...
#define RSCALE 0.03            /* scaling factor of radial component */
#define RMAX 2.0               /* max value of radial component */
#define RMIN 0.5                /* min value of radial component */
#define COS_VISIBLE -1.1        /* limit on cosine of normal to shown facets */
...
### 22 March 24 - Aggregation of “water” molecules ###
...
#define INITXMAX 1.975	/* x interval for initial condition */
#define INITYMIN -1.1
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.00008            /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 2.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0       /* radius in which to count neighbours */
...
#define ADD_BFIELD 0     /* set to 1 to add a magnetic field */
#define BFIELD 2.666666667       /* value of magnetic field */
#define CHARGE -0.4      /* charge of particles of first type */
#define CHARGE_B 0.2     /* charge of particles of second type */
#define INCREASE_E 0     /* set to 1 to increase electric field */
#define EFIELD_FACTOR 5000000.0    /* factor by which to increase electric field */
#define INCREASE_B 0     /* set to 1 to increase magnetic field */
#define BFIELD_FACTOR 20000.0    /* factor by which to increase magnetic field */
...
#define AGREG_DECOUPLE 3        /* minimal number of partners to decouple from thermostat */
...
#define NARMS 3             /* number of "arms" for certain paring types */ 
...
#define PAIR_TYPEB_PARTICLES 0  /* set to 1 to pair particle of type 1 */
#define NPARTNERS_B 9         /* number of partners of particles */
#define NARMS_B 3             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE_B 61      /* type of pairing, see POLY_ in global_ljones.c */
#define MU_D 0.014            /* radius of partner particle */
#define PARTICLE_MASS_D 2.0  /* mass or partner particle */
...
### 21 March 24 - 3d rendering of the average energy in a Ritchey-Chrétien telescope ###
...
### 20 March 24 - An incompressible Euler shear flow on the sphere - 2D representation ###
...
### 19 March 24 - Aggregation of neutral particles ###
...
#define LAMBDA 0.75	    /* parameter controlling the dimensions of domain */
#define MU 0.0125 	    /* parameter controlling radius of particles */
#define MU_B 0.0125           /* parameter controlling radius of particles of second type */
#define NPOLY 40            /* number of sides of polygon */
#define APOLY 0.0           /* angle by which to turn polygon, in units of Pi/2 */ 
#define AWEDGE 0.5          /* opening angle of wedge, in units of Pi/2 */ 
#define MDEPTH 4            /* depth of computation of Menger gasket */
...
#define COLLISION_TIME 25       /* time during which collisions are shown */
#define DELTAVMAX 150.0         /* maximal deltav allowed for pairing molecules */
#define AGREGMAX 5              /* maximal number of partners for CHEM_AGGREGATION reaction */
#define AGREG_DECOUPLE 2        /* minimal number of partners to decouple from thermostat */
...
#define PAIR_SAFETY_FACTOR 1.2  /* distance to deactivate divided by sum of radii */
#define KSPRING_PAIRS 2.0e10    /* spring constant for pair interaction */
#define NPARTNERS 1         /* number of partners of particles */
#define NARMS 3             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE 61      /* type of pairing, see POLY_ in global_ljones.c */
#define PARTNER_ANGLE 104.45    /* angle (in degrees) between ions for POLY_WATER case */
#define PAIR_DRATIO 1.0     /* ratio between equilibrium distance and radius (default: 1.0) */
...
### 18 March 24 - Energy flow through a Sierpinski carpet, in 3D - linear scale ###
...
### 17 March 24 - An incompressible Euler shear flow on the sphere ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_shear_flow_sphere(0.5, 0.25, 0.25, 6, 5, 0.75, phi, xy_in, wsphere);`
...
### 16 March 24 - Increasing the force constant for coagulating molecules ###
...
### 15 March 24 - A Ritchey-Chrétien telescope with better focus ###
...
#define OSCILLATE_LEFT 1     /* set to 1 to add oscilating boundary condition on the left */
#define OSCILLATE_TOPBOT 0   /* set to 1 to enforce a planar wave on top and bottom boundary */
#define OSCILLATION_SCHEDULE 21  /* oscillation schedule, see list in global_pdes.c */
#define OSCIL_YMAX 0.35      /* defines oscillation range */
#define INITIAL_SHIFT 20.0          /* time shift of initial wave packet (in oscillation periods) */
#define WAVE_PACKET_SHIFT 200.0     /* time shift between wave packets (in oscillation periods) */
...
### 14 March 24 - Four quantum wave packets interacting on a sphere ###
...
#define DPOLE 1         /* safety distance to poles */
#define DSMOOTH 10      /* size of neighbourhood of poles that are smoothed */
#define SMOOTHPOLE 0.5  /* smoothing coefficient at poles */
#define PHISHIFT 0.0    /* shift of phi in 2D plot (in degrees) */
...
#define SCALE 0          /* set to 1 to adjust color scheme to variance of field */
#define SLOPE 1.0        /* sensitivity of color on wave amplitude */
#define VSCALE_AMPLITUDE 4.0      /* additional scaling factor for color scheme P_3D_AMPLITUDE */
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
#define CURL_SCALE 0.000015   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define SLOPE_SCHROD_LUM 100.0       /* sensitivity of luminosity on module, for color scheme Z_ARGUMENT */
...
#define RSCALE 0.4            /* scaling factor of radial component */
#define RMAX 2.0               /* max value of radial component */
#define RMIN 0.5                /* min value of radial component */
#define COS_VISIBLE -1.1        /* limit on cosine of normal to shown facets */
...
#define RSCALE 0.6            /* scaling factor of radial component */
#define RMAX 2.0               /* max value of radial component */
#define RMIN 0.5                /* min value of radial component */
#define COS_VISIBLE -1.1        /* limit on cosine of normal to shown facets */
...
### 13 March 24 - Coagulating molecules, with stronger interaction and cluster coloring ###
...
### 12 March 24 - Energy flow through a Sierpinski carpet, in 3D - linear scale ###
...
### 11 March 24 - Asymmetric Rock-paper-scissors-lizard-Spock equation on the sphere ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_random_smoothed(0.5, 0.25, phi, xy_in, wsphere);`
...
#define DPOLE 1         /* safety distance to poles */
#define DSMOOTH 10      /* size of neighbourhood of poles that are smoothed */
#define SMOOTHPOLE 0.39  /* smoothing coefficient at poles */
#define PHISHIFT 0.0    /* shift of phi in 2D plot (in degrees) */
...
#define RMAX 1.05                /* max value of radial component */
...
### 10 March 24 - Coagulating molecules ###
...
#define DELTA_EKIN 2000.0        /* change of kinetic energy in reaction */
#define COLLISION_TIME 25       /* time during which collisions are shown */
#define DELTAVMAX 50.0           /* maximal deltav allowed for pairing molecules */
...
### 09 March 24 - A Ritchey-Chrétien telescope ###
...
### 08 March 24 - Two quantum wave packets colliding on a sphere - 2D representation ###
...
```
    init_coherent_state_sphere(0, 0.0, PID, 10.0, 0.0, 0.1, phi, xy_in, wsphere);
    init_coherent_state_sphere(1, PI, PID, -10.0, 0.0, 0.1, phi, xy_in, wsphere);
...
### 07 March 24 - A molecular foam made of cooled tripods ###
...
#define PAIR_SAFETY_FACTOR 1.2  /* distance to deactivate divided by sum of radii */
#define KSPRING_PAIRS 2.0e10    /* spring constant for pair interaction */
#define NPARTNERS 9         /* number of partners of particles */
#define NARMS 3             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE 61      /* type of pairing, see POLY_ in global_ljones.c */
#define PARTNER_ANGLE 104.45    /* angle (in degrees) between ions for POLY_WATER case */
#define PAIR_DRATIO 1.0     /* ratio between equilibrium distance and radius (default: 1.0) */
...
### 06 March 24 - A Michelson interferometer (short version) ###
...
#define B_DOMAIN 741        /* choice of domain shape, see list in global_pdes.c */
...
#define LAMBDA 0.35	    /* parameter controlling the dimensions of domain */
...
### 05 March 24 - Two quantum wave packets colliding on a sphere ###
...
### 04 March 24 - Interacting tripods in an increasing electric field ###
...
#define RANDOM_RADIUS 0     /* set to 1 for random circle radius */
#define DT_PARTICLE 3.0e-6    /* time step for particle displacement */
#define KREPEL 75.0          /* constant in repelling force between particles */
#define EQUILIBRIUM_DIST 5.0    /* Lennard-Jones equilibrium distance */
#define EQUILIBRIUM_DIST_B 5.0  /* Lennard-Jones equilibrium distance for second type of particle */
#define REPEL_RADIUS 25.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 300.0          /* damping coefficient of particles */
...
#define INCREASE_BETA 0  /* set to 1 to increase BETA during simulation */
#define BETA_SCHEDULE 6    /* type of temperature schedule, see TS_* in global_ljones */
#define BETA_FACTOR 0.0001    /* factor by which to change BETA during simulation */
#define N_TOSCILLATIONS 1.0   /* number of temperature oscillations in BETA schedule */
#define NO_OSCILLATION 0        /* set to 1 to have exponential BETA change only */
#define MIDDLE_CONSTANT_PHASE 0   /* final phase in which temperature is constant */
#define FINAL_DECREASE_PHASE 0    /* final phase in which temperature decreases */ 
...
### 03 March 24 - Moving one mirror in a Michelson interferometer - time lapse of averaged energy ###
...
### 02 March 24 - From 3-armed to 5-armed spirals in the rock-paper-scissors-lizard-Spock equation on the sphere ###
...
### 01 March 24 - Rigid interacting tripod molecules ###
...
#define ADD_EFIELD 1     /* set to 1 to add an electric field */
#define EFIELD 533333.33333       /* value of electric field */
#define ADD_BFIELD 0     /* set to 1 to add a magnetic field */
#define BFIELD 2.666666667       /* value of magnetic field */
#define CHARGE -0.0      /* charge of particles of first type */
#define CHARGE_B 0.0     /* charge of particles of second type */
...
#define PAIR_SAFETY_FACTOR 1.2  /* distance to deactivate divided by sum of radii */
#define KSPRING_PAIRS 2.0e10    /* spring constant for pair interaction */
#define NPARTNERS 12         /* number of partners of particles */
#define NARMS 3             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE 61      /* type of pairing, see POLY_ in global_ljones.c */
#define PARTNER_ANGLE 104.45    /* angle (in degrees) between ions for POLY_WATER case */
#define PAIR_DRATIO 1.25     /* ratio between equilibrium distance and radius (default: 1.0) */
#define MU_C 0.014            /* radius of partner particle */
#define PARTICLE_MASS_C 2.0  /* mass or partner particle */
#define CHARGE_C 1.5         /* charge of partner particle */

#define PAIR_TYPEB_PARTICLES 1  /* set to 1 to pair particle of type 1 */
#define NPARTNERS_B 12         /* number of partners of particles */
#define NARMS_B 3             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE_B 61      /* type of pairing, see POLY_ in global_ljones.c */
#define MU_D 0.014            /* radius of partner particle */
#define PARTICLE_MASS_D 2.0  /* mass or partner particle */
