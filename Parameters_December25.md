...
### 31 December 2025 - Spherical pool ###
...
#define INITXMAX 3.35	/* x interval for initial condition */
...
#define V_INITIAL_ADD 3000.0        /* initial velocity range for added particles */
...
#define ADD_PERIOD 1000      /* time interval between adding further particles */
...
double observer[3] = {-3.0, 1.0, 1.0};    /* location of observer for REP_PROJ_3D representation */ 
...
### 30 December 2025 - Sending a beam into an equilateral triangle pointing to the right ###
...
#define AMPLITUDE 3.5      /* amplitude of periodic excitation */ 
...
### 29 December 2025 - Particles forming polymers on a sphere, corrected version ###

**Program:** `lennardjones.c` 

**3D version, observer moving west:**
...
#define INITYMIN 0.3
#define INITYMAX 2.84	/* y interval for initial condition */
...
**3D version, observer moving east:**
...
### 28 December 2025 - Sending a beam into an equilateral triangle ###
...
#define MU 0.575              /* parameter controlling the dimensions of domain */
#define MU_B 0.3            /* parameter controlling the dimensions of domain */
#define NPOLY 6             /* number of sides of polygon */
#define APOLY 0.0           /* angle by which to turn polygon, in units of Pi/2 */ 
#define MDEPTH 6            /* depth of computation of Menger gasket */
...
#define DRAW_COLOR_SCHEME 1     /* set to 1 to plot the color scheme */
#define COLORBAR_RANGE 1.7      /* scale of color scheme bar */
#define COLORBAR_RANGE_B 7.5    /* scale of color scheme bar for 2nd part */
#define ROTATE_COLOR_SCHEME 0   /* set to 1 to draw color scheme horizontally */
#define CIRC_COLORBAR 0         /* set to 1 to draw circular color scheme */
#define CIRC_COLORBAR_B 0       /* set to 1 to draw circular color scheme */
...
### 27 December 2025 - Interacting "tripods" on a sphere ###
...
#define DT_PARTICLE 1.0e-6    /* time step for particle displacement */
#define KREPEL 40.0           /* constant in repelling force between particles */
#define EQUILIBRIUM_DIST 5.5    /* Lennard-Jones equilibrium distance */
#define EQUILIBRIUM_DIST_B 5.5  /* Lennard-Jones equilibrium distance for second type of particle */
#define SEGMENT_FORCE_EQR 1.0   /* equilibrium distance factor for force from segments (default 1.5) */
#define REPEL_RADIUS 25.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 0.0          /* damping coefficient of particles */
#define INITIAL_DAMPING 1000.0  /* damping coefficient of particles during initial phase */
...
#define PARTICLE_MASS_B 3.0     /* mass of particle of radius MU_B */
#define PARTICLE_ADD_MASS 1.0   /* mass of added particles */
#define PARTICLE_ADD_MASS_B 1.0   /* mass of added particles */
#define PARTICLE_INERTIA_MOMENT 0.1     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.1     /* moment of inertia of second type of particle */
...
#define VICSEK_VMAX 40.0    /* minimal speed of particles in Vicsek model */
#define COULOMB_LJ_FACTOR 1.0   /* relative intensity of LJ interaction in I_COULOMB_LJ interaction (default: 0.01) */
#define KCOULOMB_FACTOR 1000.0  /* relative intensity of Coulomb interaction in I_COULOMB_LJ (default: 100.0) */
#define OBSTACLE_DAMPING 0.0   /* damping of oscillating obstacles */
...
#define REACTION_DIST 5.4         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.1              /* max orientation difference for pairing polygons */
#define CENTER_COLLIDED_PARTICLES 1  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define EXOTHERMIC 0            /* set to 1 to make reaction exo/endothermic */
#define DELTA_EKIN 0.0       /* change of kinetic energy in reaction */
#define CORRECT_EQUILIBRIUM_POSITION 1  /* set to 1 to nudge particle dist towards eq dist */
#define NUDGE_FACTOR 0.0005      /* factor by which to correct particle distance */
#define COLLISION_TIME 20       /* time during which collisions are shown */
#define COLLISION_RADIUS 3.0    /* radius of discs showing collisions, in units of MU */
#define DELTAVMAX 500.0         /* maximal deltav allowed for pairing molecules */
...
#define KTORQUE_PAIRS 1.0e10   /* constant for angular coupling in pair interaction */
#define KTORQUE_PAIR_ANGLE 0.0    /* constant for coupling between orientation in pairs */
#define NPARTNERS 3         /* number of partners of particles - for DNA, set NPARTNERS_DNA */
#define NPARTNERS_DNA 8     /* number of partners of particles, case of DNA, should be at least 8 */
#define NARMS 4             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE 11      /* type of pairing, see POLY_ in global_ljones.c */
#define PARTNER_ANGLE 104.45    /* angle (in degrees) between ions for POLY_WATER case */
#define PAIR_DRATIO 1.2      /* ratio between equilibrium distance and radius (default: 1.0) */
#define MU_C 0.022            /* radius of partner particle */
#define PARTICLE_MASS_C 1.0  /* mass or partner particle */
#define CHARGE_C -1.0         /* charge of partner particle */
#define CLUSTER_COLOR_FACTOR 40  /* factor for initialization of cluster colors */
...
#define NPARTNERS_B 3         /* number of partners of particles */
#define NARMS_B 1               /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE_B 11     /* type of pairing, see POLY_ in global_ljones.c */
#define MU_D 0.022            /* radius of partner particle */
#define PARTICLE_MASS_D 1.0  /* mass or partner particle */
#define CHARGE_D 1.0         /* charge of partner particle */
...
### 26 December 2025 - Sending a beam into an octagon ###
...
#define MU 0.07612047       /* parameter controlling the dimensions of domain */
#define MU_B 0.3            /* parameter controlling the dimensions of domain */
...
### 25 December 2025 - A snow globe (short version) ###
...
#define INITXMAX 6.255	/* x interval for initial condition */
#define INITYMIN 1.6
#define INITYMAX 2.8	/* y interval for initial condition */
...
#define ADDXMIN 0.1
#define ADDXMAX 6.2	/* x interval for adding particles */
#define ADDYMIN 2.8
...
#define BCXMAX 6.283185307	/* x interval for boundary condition */
#define BCYMIN 0.2
#define BCYMAX 2.941592654	/* y interval for boundary condition */
...
#define P_PERCOL 0.25       /* probability of having a circle in C_RAND_PERCOL arrangement */
#define NPOISSON 100        /* number of points for Poisson C_RAND_POISSON arrangement */
#define PDISC_DISTANCE 13.0  /* minimal distance in Poisson disc process, controls density of particles */
#define PDISC_CANDIDATES 100 /* number of candidates in construction of Poisson disc process */
#define RANDOM_POLY_ANGLE 0 /* set to 1 to randomize angle of polygons */
...
#define MU_ADD 0.008        /* parameter controlling radius of added particles */
#define MU_ADD_B 0.008      /* parameter controlling radius of added particles */
#define NPOLY 3             /* number of sides of polygon */
#define APOLY 0.0           /* angle by which to turn polygon, in units of Pi/2 */ 
#define AWEDGE 0.5          /* opening angle of wedge, in units of Pi/2 */ 
#define MDEPTH 4            /* depth of computation of Menger gasket */
...
#define NOBSX 24
#define NOBSY 14           /* obstacles for O_HEX obstacle pattern */
#define NTREES 30           /* number of trees in S_TREES */
#define OFSSET_TREES 0.5    /* vertical offset in S_TREES_B */
#define SLOPE_TREES 0.015   /* slope in S_TREES_B (default: 0.3) */
#define SLOPE_TREES_B 0.015   /* slope in S_TREES_B (default: 0.25) */
...
#define ADD_TYPE 0        /* type of added particles */
...
#define KTORQUE_PAIRS 1.0e10   /* constant for angular coupling in pair interaction */
#define KTORQUE_PAIR_ANGLE 0.0    /* constant for coupling between orientation in pairs */
#define NPARTNERS 6         /* number of partners of particles - for DNA, set NPARTNERS_DNA */
#define NPARTNERS_DNA 8     /* number of partners of particles, case of DNA, should be at least 8 */
#define NARMS 4             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE 11      /* type of pairing, see POLY_ in global_ljones.c */
#define PARTNER_ANGLE 104.45    /* angle (in degrees) between ions for POLY_WATER case */
#define PAIR_DRATIO 1.2      /* ratio between equilibrium distance and radius (default: 1.0) */
#define MU_C 0.008            /* radius of partner particle */
#define PARTICLE_MASS_C 1.0  /* mass or partner particle */
#define CHARGE_C 0.0         /* charge of partner particle */
#define CLUSTER_COLOR_FACTOR 40  /* factor for initialization of cluster colors */
#define ALTERNATE_POLY_CHARGE 0  /* set to 1 for alternating charges in molecule */
#define SECONDARY_PAIRING 0     /* set to 1 to pair with secondary partners, experimental */
#define DNA_RIGIDITY 0.5     /* controls rigidity for POLY_DNA_DOUBLE pairs, default = 1 */
...
#define PARTICLE_MASS_D 1.0  /* mass or partner particle */
#define CHARGE_D 0.0         /* charge of partner particle */
...
double light[3] = {0.40824829, -0.816496581, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {3.0, -3.0, -1.5};    /* location of observer for REP_PROJ_3D representation */ 

```

### 25 December 2025 - A Christmas snow globe ###
...
#define INITXMAX 6.255	/* x interval for initial condition */
#define INITYMIN 1.3
#define INITYMAX 2.9	/* y interval for initial condition */
...
### 24 December 2025 - Lighting the Christmas tree ###
...
#define B_DOMAIN 731         /* choice of domain shape, see list in global_pdes.c */
...
#define OSCILLATION_SCHEDULE 42  /* oscillation schedule, see list in global_pdes.c */
#define OSCIL_YMAX 0.0375          /* defines oscilling beam range */
#define OSCIL_YMID -0.935          /* defines oscilling beam midpoint */
#define INITIAL_SHIFT 20.0          /* time shift of initial wave packet (in oscillation periods) */
#define WAVE_PACKET_SHIFT 200.0     /* time shift between wave packets (in oscillation periods) */
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.01        /* Courant number in medium B */
#define COURANTB 0.25      /* Courant number */
#define GAMMA 5.0e-5          /* damping factor in wave equation */
#define GAMMAB 0.0         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
#define GAMMA_TOPBOT 1.0e-7     /* damping factor on boundary */
#define KAPPA 0.0           /* "elasticity" term enforcing oscillations */
...
#define NSTEPS 2075          /* number of frames of movie */
...
### 23 December 2025 - Interacting "hexapods" on a sphere ###
...
#define MANDELLIMIT 10.0    /* limit value for approximation of Mandelbrot set */
#define FOCI 1              /* set to 1 to draw focal points of ellipse */
#define NGRIDX 22           /* number of grid point for grid of disks */
#define NGRIDY 11          /* number of grid point for grid of disks */
#define EHRENFEST_RADIUS 0.9    /* radius of container for Ehrenfest urn configuration */
#define EHRENFEST_WIDTH 0.035     /* width of tube for Ehrenfest urn configuration */
#define TWO_CIRCLES_RADIUS_RATIO 0.8    /* ratio of radii for S_TWO_CIRCLES_EXT segment configuration */
#define DAM_WIDTH 0.05       /* width of dam for S_DAM segment configuration */
...
#define PARTICLE_HUE_MAX 0.0        /* color of saturated particle */
#define PARTICLE_EMIN 0.0           /* energy of particle with coolest color */
#define PARTICLE_EMAX 35000.0        /* energy of particle with hottest color */
#define PARTICLE_DMIN 200.0         /* energy of particle with largest local density */
#define PARTICLE_DMAX 500.0         /* energy of particle with largest local density */
#define SEGMENT_HUE_MIN 275.0       /* color of original segment */
#define SEGMENT_HUE_MAX 30.0        /* color of saturated segment */
...
### 22 December 2025 - Effect of the wavelength on a laser-like resonator ###
...
#define B_DOMAIN 1952         /* choice of domain shape, see list in global_pdes.c */
...
#define MU 1.5              /* parameter controlling the dimensions of domain */
#define MU_B 0.3            /* parameter controlling the dimensions of domain */
#define NPOLY 3             /* number of sides of polygon */
#define APOLY 0.25          /* angle by which to turn polygon, in units of Pi/2 */ 
#define MDEPTH 6            /* depth of computation of Menger gasket */
...
#define OSCILLATION_SCHEDULE 42  /* oscillation schedule, see list in global_pdes.c */
#define OSCIL_YMAX 0.0375          /* defines oscilling beam range */
#define OSCIL_YMID -0.7125          /* defines oscilling beam midpoint */
#define INITIAL_SHIFT 20.0          /* time shift of initial wave packet (in oscillation periods) */
#define WAVE_PACKET_SHIFT 200.0     /* time shift between wave packets (in oscillation periods) */

#define OMEGA 0.05         /* frequency of periodic excitation */
#define AMPLITUDE 2.0      /* amplitude of periodic excitation */ 
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.1        /* Courant number in medium B */
...
```
#define OSCILLATING_SOURCE_PERIOD 4.0   /* period of oscillating source */
...
```
#define OSCILLATING_SOURCE_PERIOD 2.0   /* period of oscillating source */

```

### 21 December 2025 - A supercritical chain reaction on the sphere ###
...
#define ADDYMIN 1.5
#define ADDYMAX 1.6	/* y interval for adding particles */
#define ADDRMIN 2.0 
#define ADDRMAX 2.1     /* r interval for adding particles */
...
#define PARTICLE_HUE_MAX 0.0        /* color of saturated particle */
#define PARTICLE_EMIN 0.0           /* energy of particle with coolest color */
#define PARTICLE_EMAX 500000.0        /* energy of particle with hottest color */
#define PARTICLE_DMIN 200.0         /* energy of particle with largest local density */
#define PARTICLE_DMAX 500.0         /* energy of particle with largest local density */
#define SEGMENT_HUE_MIN 275.0       /* color of original segment */
#define SEGMENT_HUE_MAX 30.0        /* color of saturated segment */
...
#define SPECIAL_IC 2              /* set to 1 for choosing special initial condition RD_INITIAL_COND */
#define REACTION_DIFFUSION 1     /* set to 1 to simulate a chemical reaction (particles may change type) */
#define REACTION_MAX_TIME 100000     /* time after which no reactions take place */  
...
### 20 December 2025 - Sending a beam into a hexagon ###
...
#define LAMBDA 1.0	    /* parameter controlling the dimensions of domain */
#define MU 0.133974596            /* parameter controlling the dimensions of domain */
...
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.08       /* Courant number in medium B */
#define COURANTB 0.2       /* Courant number */
#define GAMMA 5.0e-6          /* damping factor in wave equation */
#define GAMMAB 0.0         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
#define GAMMA_TOPBOT 1.0e-7     /* damping factor on boundary */
...
#define ADD_OSCILLATING_SOURCE 0        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 6.25  /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 1                     /* number of sources, for option draw_sources */
#define ALTERNATE_SOURCE_PHASES 0       /* set to 1 to alternate initial phases of sources */
#define MAX_PULSING_TIME 5000           /* max time for adding pulses */
...
#define DRAW_COLOR_SCHEME 1     /* set to 1 to plot the color scheme */
#define COLORBAR_RANGE 1.9      /* scale of color scheme bar */
#define COLORBAR_RANGE_B 4.2    /* scale of color scheme bar for 2nd part */
#define ROTATE_COLOR_SCHEME 0   /* set to 1 to draw color scheme horizontally */
#define CIRC_COLORBAR 0         /* set to 1 to draw circular color scheme */
#define CIRC_COLORBAR_B 0       /* set to 1 to draw circular color scheme */
...
### 19 December 2025 - Interacting "quadrupods" on a sphere ###
...
#define PARTICLE_HUE_MAX 0.0        /* color of saturated particle */
#define PARTICLE_EMIN 0.0           /* energy of particle with coolest color */
#define PARTICLE_EMAX 25000.0        /* energy of particle with hottest color */
#define PARTICLE_DMIN 200.0         /* energy of particle with largest local density */
#define PARTICLE_DMAX 500.0         /* energy of particle with largest local density */
#define SEGMENT_HUE_MIN 275.0       /* color of original segment */
#define SEGMENT_HUE_MAX 30.0        /* color of saturated segment */
...
#define RD_PLOT_TYPES 8           /* number of types shown in graph */
#define RD_INITIAL_COND 0         /* initial condition of particles */
#define REACTION_DIST 10.0         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.1              /* max orientation difference for pairing polygons */
...
#define PAIRING_TYPE 11      /* type of pairing, see POLY_ in global_ljones.c */
#define PARTNER_ANGLE 104.45    /* angle (in degrees) between ions for POLY_WATER case */
#define PAIR_DRATIO 1.5      /* ratio between equilibrium distance and radius (default: 1.0) */
#define MU_C 0.022            /* radius of partner particle */
#define PARTICLE_MASS_C 1.0  /* mass or partner particle */
#define CHARGE_C -1.0         /* charge of partner particle */
#define CLUSTER_COLOR_FACTOR 40  /* factor for initialization of cluster colors */
...
#define PAIR_TYPEB_PARTICLES 1  /* set to 1 to pair particle of type 1 */
#define NPARTNERS_B 4         /* number of partners of particles */
#define NARMS_B 1               /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE_B 11     /* type of pairing, see POLY_ in global_ljones.c */
#define MU_D 0.022            /* radius of partner particle */
#define PARTICLE_MASS_D 1.0  /* mass or partner particle */
...
### 18 December 2025 - Sending a beam into a square ###
...
#define LAMBDA 1.0	    /* parameter controlling the dimensions of domain */
#define MU -0.414214        /* parameter controlling the dimensions of domain */
#define MU_B 1.0            /* parameter controlling the dimensions of domain */
...
#define DRAW_COLOR_SCHEME 1     /* set to 1 to plot the color scheme */
#define COLORBAR_RANGE 1.7      /* scale of color scheme bar */
#define COLORBAR_RANGE_B 5.6    /* scale of color scheme bar for 2nd part */
#define ROTATE_COLOR_SCHEME 0   /* set to 1 to draw color scheme horizontally */
#define CIRC_COLORBAR 0         /* set to 1 to draw circular color scheme */
#define CIRC_COLORBAR_B 0       /* set to 1 to draw circular color scheme */
...
### 17 December 2025 - Energy of a slightly subcritical chain reaction on the sphere ###
...
### 16 December 2025 - A laser-like resonating cavity with improved geometry ###
...
### 15 December 2025 - A chain reaction on a sphere ###
...
### 14 December 2025 - Sending a beam into a seven-pointed star ###
...
#define LAMBDA 1.0	    /* parameter controlling the dimensions of domain */
#define MU 0.3079785        /* parameter controlling the dimensions of domain */
#define MU_B 1.0            /* parameter controlling the dimensions of domain */
...
### 13 December 2025 - Energy of polymerizing polymers on a sphere ###
...
#define RD_PLOT_TYPES 8           /* number of types shown in graph */
#define RD_INITIAL_COND 0         /* initial condition of particles */
#define REACTION_DIST 5.0         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.1              /* max orientation difference for pairing polygons */
...
#define KTORQUE_PAIRS 1.0e10   /* constant for angular coupling in pair interaction */
#define KTORQUE_PAIR_ANGLE 0.0    /* constant for coupling between orientation in pairs */
#define NPARTNERS 18         /* number of partners of particles - for DNA, set NPARTNERS_DNA */
#define NPARTNERS_DNA 8     /* number of partners of particles, case of DNA, should be at least 8 */
#define NARMS 4             /* number of "arms" for certain paring types */ 
#define PAIRING_TYPE 5      /* type of pairing, see POLY_ in global_ljones.c */
#define PARTNER_ANGLE 104.45    /* angle (in degrees) between ions for POLY_WATER case */
#define PAIR_DRATIO 1.0      /* ratio between equilibrium distance and radius (default: 1.0) */
#define MU_C 0.022            /* radius of partner particle */
#define PARTICLE_MASS_C 1.0  /* mass or partner particle */
...
### 12 December 2025 - A high-frequency beam sent between the focal points of an elliptical resonator ###
...
#define B_DOMAIN 983         /* choice of domain shape, see list in global_pdes.c */
...
#define OMEGA 0.1          /* frequency of periodic excitation */
#define AMPLITUDE 2.0      /* amplitude of periodic excitation */ 
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.08       /* Courant number in medium B */
...
#define KAPPA_SIDES 5.0e-4  /* "elasticity" term on absorbing boundary */
#define KAPPA_TOPBOT 0.0    /* "elasticity" term on absorbing boundary */
#define OSCIL_LEFT_YSHIFT 320.0   /* y-dependence of left oscillation (for non-horizontal waves) */
/* The Courant number is given by c*DT/DX, where DT is the time step and DX the lattice spacing */
/* The physical damping coefficient is given by GAMMA/(DT)^2 */
/* Increasing COURANT speeds up the simulation, but decreases accuracy */
/* For similar wave forms, COURANT^2*GAMMA should be kept constant */
...
### 11 December 2025 - Pearl necklace jam: polymers linking up on a sphere (short) ###
...
### 10 December 2025 - 3D representation of a beam of light sent between the focal points of an elliptical cavity ###
...
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define MAX_PULSING_TIME 2500           /* max time for adding pulses */
...
### 09 December 2025 - Polymers forming longer polymers on a sphere ###
...
#define FOCI 1              /* set to 1 to draw focal points of ellipse */
#define NGRIDX 10           /* number of grid point for grid of disks */
#define NGRIDY 7           /* number of grid point for grid of disks */
#define EHRENFEST_RADIUS 0.9    /* radius of container for Ehrenfest urn configuration */
#define EHRENFEST_WIDTH 0.035     /* width of tube for Ehrenfest urn configuration */
#define TWO_CIRCLES_RADIUS_RATIO 0.8    /* ratio of radii for S_TWO_CIRCLES_EXT segment configuration */
#define DAM_WIDTH 0.05       /* width of dam for S_DAM segment configuration */
...
### 08 December 2025 - A laser-like resonating cavity with a lens ###
...
#define B_DOMAIN 1951         /* choice of domain shape, see list in global_pdes.c */
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 5.0   /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 1                     /* number of sources, for option draw_sources */
#define ALTERNATE_SOURCE_PHASES 0       /* set to 1 to alternate initial phases of sources */
#define MAX_PULSING_TIME 5000           /* max time for adding pulses */
...
### 07 December 2025 - Forming long polymers on a sphere ###
...
#define REACTION_DIFFUSION 1     /* set to 1 to simulate a chemical reaction (particles may change type) */
#define REACTION_MAX_TIME 100000     /* time after which no reactions take place */  
#define RD_REACTION 221             /* type of reaction, see list in global_ljones.c */
#define RD_TYPES 8                /* number of types in reaction-diffusion equation */
#define RD_PLOT_TYPES 8           /* number of types shown in graph */
#define RD_INITIAL_COND 2         /* initial condition of particles */
#define REACTION_DIST 2.85        /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.1              /* max orientation difference for pairing polygons */
...
### 06 December 2025 - Sending a beam of light between the focal points of an elliptical cavity ###
...
### 05 December 2025 - Particles forming clusters on the sphere ###

**Program:** `lennardjones.c` 

**3D part, observer moving west:** 
...
### 04 December 2025 - A resonator modeling a laser ###
...
#define B_DOMAIN 195         /* choice of domain shape, see list in global_pdes.c */
...
#define OSCILLATE_TOPBOT 0   /* set to 1 to enforce a planar wave on top and bottom boundary */
#define OSCILLATION_SCHEDULE 42  /* oscillation schedule, see list in global_pdes.c */
#define OSCIL_YMAX 0.04       /* defines oscilling beam range */
#define OSCIL_YMID 0.0      /* defines oscilling beam midpoint */
#define INITIAL_SHIFT 20.0          /* time shift of initial wave packet (in oscillation periods) */
#define WAVE_PACKET_SHIFT 200.0     /* time shift between wave packets (in oscillation periods) */
...
### 03 December 2025 - Particles forming larger polymers on a sphere ###
...
### 02 December 2025 - 3D view of a laser-like resonating cavity ###
...
### 01 December 2025 - Particles forming polymers on a sphere ###
