...
### 31 August 2024 - Refraction and reflection of a shock wave ###
...
### 30 August 2024 - What happened to your luggage at the airport? ###
...
#define INITXMIN -1.6
#define INITXMAX -1.5	/* x interval for initial condition */
#define INITYMIN 0.8
...
#define ADDXMIN -1.6
#define ADDXMAX -1.4	/* x interval for adding particles */
#define ADDYMIN 1.2
...
#define SEGMENT_PATTERN 34      /* pattern of repelling segments, see list in global_ljones.c */
...
#define SEGMENT_FORCE_EQR 1.2   /* equilibrium distance factor for force from segments (default 1.5) */
#define REPEL_RADIUS 25.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 600.0          /* damping coefficient of particles */
...
#define HASHX 95     /* size of hashgrid in x direction */
#define HASHY 84      /* size of hashgrid in y direction */
...
### 29 August 2024 - Classics revisited: A parabolic resonator ###
...
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 1.0e-3         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
#define GAMMA_TOPBOT 1.0e-7     /* damping factor on boundary */
#define KAPPA 0.0           /* "elasticity" term enforcing oscillations */
#define KAPPA_SIDES 5.0e-4  /* "elasticity" term on absorbing boundary */
...
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
#define FLUX_SCALE 250.0    /* scaling factor for energy flux represtnation */
#define AVRG_E_FACTOR 0.5   /* controls time window size in P_AVERAGE_ENERGY scheme */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define FADE_IN_OBSTACLE 1      /* set to 1 to fade color inside obstacles */
...
### 28 August 2024 - A conveyor belt with shovels ###
...
#define ADD_FIXED_SEGMENTS 1    /* set to 1 to add fixed segments as obstacles */
#define SEGMENT_PATTERN 33      /* pattern of repelling segments, see list in global_ljones.c */
#define ROCKET_SHAPE 3        /* shape of rocket combustion chamber, see list in global_ljones.c */
#define ROCKET_SHAPE_B 3      /* shape of second rocket */
#define NOZZLE_SHAPE 6        /* shape of nozzle, see list in global_ljones.c */
#define NOZZLE_SHAPE_B 6      /* shape of nozzle for second rocket, see list in global_ljones.c */
#define BELT_SPEED1 7.0     /* speed of first conveyor belt */
...
### 27 August 2024 - A wave source on the boundary of a parabolic resonator ###
...
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
#define FLUX_SCALE 250.0    /* scaling factor for energy flux represtnation */
#define AVRG_E_FACTOR 0.7   /* controls time window size in P_AVERAGE_ENERGY scheme */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define FADE_IN_OBSTACLE 1      /* set to 1 to fade color inside obstacles */
#define SHADE_2D 1       /* set to 1 to add pseudo-3d shading effect */ 
#define SHADE_SCALE_2D 0.05  /* lower value increases sensitivity of shading */
...
### 26 August 2024 - Conveyor belts with a separator ###
...
#define INITXMIN -1.8
#define INITXMAX -0.2	/* x interval for initial condition */
#define INITYMIN 0.5
#define INITYMAX 3.0	/* y interval for initial condition */
...
#define ADDXMIN -1.8
#define ADDXMAX -0.5	/* x interval for adding particles */
#define ADDYMIN 2.0
#define ADDYMAX 3.0	/* y interval for adding particles */
#define ADDRMIN 4.75 
#define ADDRMAX 6.0     /* r interval for adding particles */
...
#define BCXMAX 2.0	/* x interval for boundary condition */
#define BCYMIN -1.125
#define BCYMAX 3.2	/* y interval for boundary condition */
...
#define ADD_FIXED_SEGMENTS 1    /* set to 1 to add fixed segments as obstacles */
#define SEGMENT_PATTERN 32      /* pattern of repelling segments, see list in global_ljones.c */
#define ROCKET_SHAPE 3        /* shape of rocket combustion chamber, see list in global_ljones.c */
#define ROCKET_SHAPE_B 3      /* shape of second rocket */
#define NOZZLE_SHAPE 6        /* shape of nozzle, see list in global_ljones.c */
#define NOZZLE_SHAPE_B 6      /* shape of nozzle for second rocket, see list in global_ljones.c */
...
#define DAMPING 500.0          /* damping coefficient of particles */
#define INITIAL_DAMPING 1000.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 50.0      /* damping coefficient for rotation of particles */
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0   /* mass of particle of radius MU_B */
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
...
#define COUPLE_ANGLE_TO_THERMOSTAT 0    /* set to 1 to couple angular degrees of freedom to thermostat */
#define DIMENSION_FACTOR 1.0  /* scaling factor taking into account number of degrees of freedom */  
#define KTORQUE 2.0e5         /* force constant in angular dynamics */
#define KTORQUE_BOUNDARY 5.0e5  /* constant in torque from the boundary */
#define KTORQUE_B 10.0        /* force constant in angular dynamics */
#define KTORQUE_DIFF 500.0    /* force constant in angular dynamics for different particles */
#define DRAW_SPIN 0           /* set to 1 to draw spin vectors of particles */
...
#define RESAMPLE_Y 0         /* set to 1 to resample y coordinate of moved particles (for shock waves) */
#define NTRIALS 2000         /* number of trials when resampling */
#define OBSTACLE_RADIUS 0.07  /* radius of obstacle for circle boundary conditions */
#define FUNNEL_WIDTH  0.25   /* funnel width for funnel boundary conditions */
#define OBSTACLE_XMIN 0.0    /* initial position of obstacle */
#define OBSTACLE_XMAX 3.0    /* final position of obstacle */
#define RECORD_PRESSURES 0   /* set to 1 to record pressures on obstacle */
...
#define ADD_REGION 0      /* shape of add regions, cf ADD_* in global_ljones */
#define ADD_TIME 50       /* time at which to add first particle */
#define ADD_PERIOD 8       /* time interval between adding further particles */
#define N_ADD_PARTICLES 2  /* number of particles to add */
#define FINAL_NOADD_PERIOD 2200  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
#define HASHY 100      /* size of hashgrid in y direction */
#define HASHMAX 100   /* maximal number of particles per hashgrid cell */
#define HASHGRID_PADDING 0.1    /* padding of hashgrid outside simulation window */
...
### 25 August 2024 - Symmetric low-frequency pulses in a magnetron-shaped resonator ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        wave_source_x[source] = 0.1*cos((double)source*DPI/(double)N_SOURCES);
        wave_source_y[source] = 0.1*sin((double)source*DPI/(double)N_SOURCES);
        source_period = OSCILLATING_SOURCE_PERIOD;
        if (source_period < 1) source_period = 1;
        source_shift = 0;
        source_amp = INITIAL_AMP*sqrt((double)OSCILLATING_SOURCE_PERIOD/(double)source_period);
        if ((ADD_OSCILLATING_SOURCE)&&((i-source_shift)%source_period == 1))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
            add_circular_wave(-sign[source]*source_amp, wave_source_x[source], wave_source_y[source], phi, psi, xy_in);
        }
    }
...
#define B_DOMAIN 781        /* choice of domain shape, see list in global_pdes.c */
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 120    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
...
#define INITIAL_AMP 0.4             /* amplitude of initial condition */
...
#define DRAW_COLOR_SCHEME 0    /* set to 1 to plot the color scheme */
#define COLORBAR_RANGE 1.8     /* scale of color scheme bar */
#define COLORBAR_RANGE_B 1.3   /* scale of color scheme bar for 2nd part */
#define ROTATE_COLOR_SCHEME 0   /* set to 1 to draw color scheme horizontally */
#define CIRC_COLORBAR 0         /* set to 1 to draw circular color scheme */
#define CIRC_COLORBAR_B 0       /* set to 1 to draw circular color scheme */
...
### 24 August 2024 - A laminar flow over an immersed cube ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_swater_laminar_flow_sphere(0, -0.75, 0.0075, 4, 1, 0.005, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);`
...
### 23 August 2024 - Conveyor belts with periodic boundary conditions ###
...
#define INITXMIN -1.8
#define INITXMAX 0.0	/* x interval for initial condition */
#define INITYMIN 0.5
#define INITYMAX 3.0	/* y interval for initial condition */
...
#define ADD_FIXED_SEGMENTS 1    /* set to 1 to add fixed segments as obstacles */
#define SEGMENT_PATTERN 31      /* pattern of repelling segments, see list in global_ljones.c */
#define ROCKET_SHAPE 3        /* shape of rocket combustion chamber, see list in global_ljones.c */
#define ROCKET_SHAPE_B 3      /* shape of second rocket */
#define NOZZLE_SHAPE 6        /* shape of nozzle, see list in global_ljones.c */
#define NOZZLE_SHAPE_B 6      /* shape of nozzle for second rocket, see list in global_ljones.c */
...
### 22 August 2024 - A slightly refracting magnetron-shaped resonator at higher wavelength ###
...
#define NGRIDX 60           /* number of grid point for grid of disks */
#define NGRIDY 25           /* number of grid point for grid of disks */
#define WALL_WIDTH 0.04      /* width of wall separating lenses */
#define RADIUS_FACTOR 0.3   /* controls inner radius for C_RING arrangements */
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 160    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 10                     /* number of sources, for option draw_sources */
...
### 21 August 2024 - A laminar flow over an immersed octahedron ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_swater_laminar_flow_sphere(0, -0.75, 0.0075, 6, 1, 0.0025, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);` 
...
#define ADD_CORIOLIS_FORCE 1    /* set to 1 to add Coriolis force (quasigeostrophic Euler equations) */
#define VARIABLE_DEPTH 1    /* set to 1 for variable depth in shallow water equation */
#define SWATER_DEPTH 6      /* variable depth in shallow water equation */
...
#define SWATER_MIN_HEIGHT 0.025      /* min height of initial condition for shallow water equation */
#define DEPTH_FACTOR 0.15       /* proportion of min height in variable depth */
#define TANH_FACTOR 1.0         /* steepness of variable depth */
...
#define PHASE_SHIFT 0.5   /* phase shift of color scheme, in units of Pi (formerly COLOR_PHASE_SHIFT) */
...
#define RSHIFT -0.01             /* shift in radial component */
#define RMAX 5.0e3               /* max value of radial component */
#define RMIN 0.5                 /* min value of radial component */
#define COS_VISIBLE -0.75        /* limit on cosine of normal to shown facets */
...
### 20 August 2024 - Triangles on two conveyor belts ###
...
#define NOZZLE_SHAPE 6        /* shape of nozzle, see list in global_ljones.c */
#define NOZZLE_SHAPE_B 6      /* shape of nozzle for second rocket, see list in global_ljones.c */
#define BELT_SPEED1 12.0    /* speed of first conveyor belt */
#define BELT_SPEED2 -24.0   /* speed of second conveyor belt */
...
#define INTERACTION 17      /* particle interaction, see list in global_ljones.c */
#define INTERACTION_B 1     /* particle interaction for second type of particle, see list in global_ljones.c */
#define SPIN_INTER_FREQUENCY 3.0 /* angular frequency of spin-spin interaction */
#define SPIN_INTER_FREQUENCY_B 3.0 /* angular frequency of spin-spin interaction for second particle type */
#define MOL_ANGLE_FACTOR 3.0    /* rotation angle for P_MOL_ANGLE color scheme */
...
### 19 August 2024 - Classics revisited: A hyperbolic reflector ###
...
```
    ...
    /* add oscillating waves */
    wave_source_x[0] = 0.0;
    wave_source_y[0] = LAMBDA;
    wave_source_x[1] = 0.0;
    wave_source_y[1] = -LAMBDA;
    for (source = 0; source < N_SOURCES; source++)
    {
        source_period = OSCILLATING_SOURCE_PERIOD;
        source_amp = INITIAL_AMP;
        if ((ADD_OSCILLATING_SOURCE)&&(i%source_period == 1))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
            add_circular_wave(-sign[source]*source_amp, wave_source_x[source], wave_source_y[source], phi, psi, xy_in);
        }
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.127       /* Courant number */
#define COURANTB 0.01       /* Courant number in medium B */
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 1.0e-4         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
...
#define SLEEP1  1        /* initial sleeping time */
#define SLEEP2  1        /* final sleeping time */
#define MID_FRAMES 75    /* number of still frames between parts of two-part movie */
#define END_FRAMES 300    /* number of still frames at end of movie */
#define FADE 1           /* set to 1 to fade at end of movie */
...
### 18 August 2024 - A shallower laminar flow over an immersed icosahedron ###
...
#define ADD_CORIOLIS_FORCE 1    /* set to 1 to add Coriolis force (quasigeostrophic Euler equations) */
#define VARIABLE_DEPTH 1    /* set to 1 for variable depth in shallow water equation */
#define SWATER_DEPTH 8      /* variable depth in shallow water equation */
...
### 17 August 2024 - A conveyor belt ###
...
#define ADD_FIXED_SEGMENTS 1    /* set to 1 to add fixed segments as obstacles */
#define SEGMENT_PATTERN 30      /* pattern of repelling segments, see list in global_ljones.c */
#define ROCKET_SHAPE 3        /* shape of rocket combustion chamber, see list in global_ljones.c */
#define ROCKET_SHAPE_B 3      /* shape of second rocket */
#define NOZZLE_SHAPE 6        /* shape of nozzle, see list in global_ljones.c */
#define NOZZLE_SHAPE_B 6      /* shape of nozzle for second rocket, see list in global_ljones.c */
#define BELT_SPEED1 8.0    /* speed of first conveyor belt */
#define BELT_SPEED2 0.0    /* speed of second conveyor belt */
...
### 16 August 2024 - Non-coherent waves of higher frequency in a magnetron-shaped resonator ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        wave_source_x[source] = 0.05*cos((double)source*DPI/(double)N_SOURCES);
        wave_source_y[source] = 0.05*sin((double)source*DPI/(double)N_SOURCES);
        source_period = OSCILLATING_SOURCE_PERIOD - source/4;
        if (source_period < 1) source_period = 1;
        source_shift = 2*source;
        source_amp = INITIAL_AMP*sqrt((double)OSCILLATING_SOURCE_PERIOD/(double)source_period);
        if ((ADD_OSCILLATING_SOURCE)&&((i-source_shift)%source_period == 1))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
...
#define B_DOMAIN 78        /* choice of domain shape, see list in global_pdes.c */
...
### 15 August 2024 - A shallower laminar flow over an immersed dodecahedron ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_swater_laminar_flow_sphere(0, -1.0, 0.0075, 6, 1, 0.0025, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);` 
...
#define ADD_CORIOLIS_FORCE 1    /* set to 1 to add Coriolis force (quasigeostrophic Euler equations) */
#define VARIABLE_DEPTH 1    /* set to 1 for variable depth in shallow water equation */
#define SWATER_DEPTH 7      /* variable depth in shallow water equation */
...
#define SWATER_MIN_HEIGHT 0.025      /* min height of initial condition for shallow water equation */
#define DEPTH_FACTOR 0.1        /* proportion of min height in variable depth */
#define TANH_FACTOR 1.0         /* steepness of variable depth */
...
### 14 August 2024 - Hexagons make nice sand piles ###
...
### 13 August 2024 - Non-coherent waves in a magnetron-shaped resonator ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        wave_source_x[source] = 0.05*cos((double)source*DPI/(double)N_SOURCES);
        wave_source_y[source] = 0.05*sin((double)source*DPI/(double)N_SOURCES);
        source_period = OSCILLATING_SOURCE_PERIOD - source/2;
        if (source_period < 1) source_period = 1;
        source_shift = 4*source;
        source_amp = INITIAL_AMP*sqrt((double)OSCILLATING_SOURCE_PERIOD/(double)source_period);
        if ((ADD_OSCILLATING_SOURCE)&&((i-source_shift)%source_period == 1))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 40    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 10                     /* number of sources, for option draw_sources */
...
### 12 August 2024 - A laminar flow over an immersed icosahedron ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_swater_laminar_flow_sphere(0, 1.0, 0.0075, 6, 2, 0.0025, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);` 
...
#define DEPTH_FACTOR 0.025        /* proportion of min height in variable depth */
#define TANH_FACTOR 1.0         /* steepness of variable depth */
...
### 11 August 2024 - Magnetized squishy squares clogging a funnel ###
...
#define BCXMAX 2.0	/* x interval for boundary condition */
#define BCYMIN -1.125
#define BCYMAX 2.3	/* y interval for boundary condition */
...
#define COLOR_PALETTE 13             /* Color palette, see list in global_ljones.c  */
#define COLOR_PALETTE_EKIN 10        /* Color palette for kinetic energy */
#define COLOR_PALETTE_ANGLE 0        /* Color palette for angle representation */
#define COLOR_PALETTE_DIRECTION 0    /* Color palette for direction representation */
#define COLOR_PALETTE_INITIAL_POS 10 /* Color palette for initial position representation */
...
#define COUPLE_ANGLE_TO_THERMOSTAT 0    /* set to 1 to couple angular degrees of freedom to thermostat */
#define DIMENSION_FACTOR 1.0  /* scaling factor taking into account number of degrees of freedom */  
#define KTORQUE 5.0e4         /* force constant in angular dynamics */
#define KTORQUE_BOUNDARY 5.0e5  /* constant in torque from the boundary */
#define KTORQUE_B 10.0        /* force constant in angular dynamics */
#define KTORQUE_DIFF 500.0    /* force constant in angular dynamics for different particles */
#define DRAW_SPIN 0           /* set to 1 to draw spin vectors of particles */
...
#define AGREGMAX 6              /* maximal number of partners for CHEM_AGGREGATION reaction */
#define AGREG_DECOUPLE 12       /* minimal number of partners to decouple from thermostat */
#define CLUSTER_PARTICLES 1     /* set to 1 for particles to form rigid clusters */
#define CLUSTER_MAXSIZE 1000     /* max size of clusters */
#define SMALL_CLUSTER_MAXSIZE 10 /* size limitation on smaller cluster */
#define SMALL_NP_MAXSIZE 2      /* limitation on number of partners of particle in smaller cluster */
#define NOTSELECTED_CLUSTER_MAXSIZE 0   /* limit on size of clusters that can merge with non-selected cluster */
#define REPAIR_CLUSTERS 1       /* set to 1 to repair alignment in clusters */
#define REPAIR_MIN_DIST 0.75    /* relative distance below which overlapping polygons are inactivated */
...
### 10 August 2024 - Classics revisited: The dark side of the pool ###
...
```
    ...
    if ((ADD_OSCILLATING_SOURCE)&&(i%OSCILLATING_SOURCE_PERIOD == 1))
    {
        ...
        for (source = 0; source < N_SOURCES; source++)
            add_circular_wave(-sign*INITIAL_AMP, wave_source_x[source], wave_source_y[source], phi, psi, xy_in);
    }
```
...
#define VSHIFT_AMPLITUDE 0.0   /* additional shift for wave amplitude */
#define VSCALE_AMPLITUDE 0.5   /* additional scaling factor for wave amplitude */
#define E_SCALE 65.0       /* scaling factor for energy representation */
#define LOG_SCALE 0.75     /* scaling factor for energy log representation */
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
#define FLUX_SCALE 250.0    /* scaling factor for energy flux represtnation */
#define AVRG_E_FACTOR 0.9   /* controls time window size in P_AVERAGE_ENERGY scheme */
...
### 09 August 2024 - A laminar flow over an immersed dodecahedron ###
...
#define SWATER_MIN_HEIGHT 0.1      /* min height of initial condition for shallow water equation */
#define DEPTH_FACTOR 0.02        /* proportion of min height in variable depth */
#define TANH_FACTOR 1.0         /* steepness of variable depth */
...
### 08 August 2024 - Magnetized triangles in a funnel ###
...
### 07 August 2024 - Increasing the wavelength even more in a magnetron-shaped resonator ###
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 27    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 1                     /* number of sources, for option draw_sources */
...
### 06 August 2024 - Shallow water flowing over an immersed dodecahedron ###
...
```
    init_linear_blob_sphere(0, -0.2, 1.4*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 0.5*PI/3.0, 0.6*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - PI/3.0, 1.4*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 1.5*PI/3.0, 0.6*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - 2.0*PI/3.0, 1.4*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 2.5*PI/3.0, 0.6*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - PI, 1.4*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 3.5*PI/3.0, 0.6*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - 4.0*PI/3.0, 1.4*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 4.5*PI/3.0, 0.6*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - 5.0*PI/3.0, 1.4*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 5.5*PI/3.0, 0.6*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
...
### 05 August 2024 - Triangles falling through a funnel ###
...
#define BCXMAX 2.0	/* x interval for boundary condition */
#define BCYMIN -1.125
#define BCYMAX 1.625	/* y interval for boundary condition */
...
#define COUPLE_ANGLE_TO_THERMOSTAT 0    /* set to 1 to couple angular degrees of freedom to thermostat */
#define DIMENSION_FACTOR 1.0  /* scaling factor taking into account number of degrees of freedom */  
#define KTORQUE 5.0e5         /* force constant in angular dynamics */
#define KTORQUE_BOUNDARY 5.0e5  /* constant in torque from the boundary */
#define KTORQUE_B 10.0        /* force constant in angular dynamics */
#define KTORQUE_DIFF 500.0    /* force constant in angular dynamics for different particles */
#define DRAW_SPIN 0           /* set to 1 to draw spin vectors of particles */
...
### 04 August 2024 - A magnetron-shaped resonator with longer wavelength ###
...
### 03 August 2024 - Shallow water flowing over an immersed octahedron ###
...
```
    init_linear_blob_sphere(0, -0.2, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 0.5*PID, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - PID, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 1.5*PID, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - PI, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 2.5*PID, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - 3.0*PID, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 3.5*PID, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
...
### 02 August 2024 - Growth of a mono-quasicrystal out of pentagons: coloring by age ###
...
#define BCXMAX 2.0	/* x interval for boundary condition */
#define BCYMIN -2.0
#define BCYMAX 2.0	/* y interval for boundary condition */
...
#define PLOT 22
#define PLOT_B 16        /* plot type for second movie */
...
#define COLOR_PALETTE 13             /* Color palette, see list in global_ljones.c  */
#define COLOR_PALETTE_EKIN 10        /* Color palette for kinetic energy */
#define COLOR_PALETTE_ANGLE 18       /* Color palette for angle representation */
#define COLOR_PALETTE_DIRECTION 0    /* Color palette for direction representation */
#define COLOR_PALETTE_INITIAL_POS 10 /* Color palette for initial position representation */
#define COLOR_PALETTE_DIFFNEIGH 10   /* Color palette for different neighbours representation */
#define COLOR_PALETTE_PRESSURE 11    /* Color palette for different neighbours representation */
...
### 01 August 2024 - A magnetron-shaped resonator ###
...
#define INITIAL_AMP 0.50             /* amplitude of initial condition */
#define INITIAL_VARIANCE 0.00001    /* variance of initial condition */
#define INITIAL_WAVELENGTH  0.025   /* wavelength of initial condition */
