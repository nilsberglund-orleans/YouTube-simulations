...
### 30 November 22 - 3D view of a wave refracted on a chessboard ###
...
#define NX 2730          /* number of grid points on x axis */
...
### 29 November 22 - A shear flow with an elliptical obstacle ###
...
### 28 November 22 - A cave-in with square grains of sand ###
...
### 27 November 22 - Shining a rotating laser beam into a 16 by 16 maze ###
...
#define MIN_ANGLE 40.0         /* range of angles of trajectory */
...
#define GRAPH_HUE 100.0     /* color hue of graph */
#define SUCCESS_HUE 150.0   /* color hue of success */
...
### 26 November 22 - Refraction of a wave on a honeycomb lattice with inverted wave speeds ###
...
### 25 November 22 - An incompressible flow in a maze ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_laminar_flow(1.0, 1.0, 1.0, 0.5, phi, xy_in);`
...
### 24 November 22 - Modeling a cave-in with Lennard-Jones particles, version with stronger damping ###
...
### 23 November 22 - Solving a 48 by 48 maze with laser beams ###
...
#define NYMAZE 48      /* height of maze */
#define MAZE_MAX_NGBH 4     /* max number of neighbours of maze cell */
#define RAND_SHIFT 1        /* seed of random number generator */
#define MAZE_XSHIFT 0.0     /* horizontal shift of maze */
...
### 22 November 22 - Refraction of a wave on a honeycomb lattice ###
...
### 21 November 22 - A shear flow with an obstacle ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_shear_flow(1.0, 0.02, 0.15, 1, 1, phi, xy_in);`
