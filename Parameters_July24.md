...
### 31 July 2024 - Shallow water flowing over an immersed cube ###
...
```
    ...
    init_linear_blob_sphere(1, 0.2 - PI/3.0, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - DPI/3.0, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - PI, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, -0.2 - 2.0*DPI/3.0, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 0.2 - 5.0*PI/3.0, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
...
### 30 July 2024 - Growth of a mono-quasicrystal out of pentagons ###
...
### 29 July 2024 - Ceci ne sont pas des photons ###
...
```
    ...
    wave_source_x[0] = -1.815;
    wave_source_x[1] = -1.25;
    wave_source_x[2] = -0.45;
    wave_source_x[3] = 0.07;
    wave_source_x[4] = 0.62;
    wave_source_x[5] = 1.25;
    wave_source_x[6] = 1.75;
    wave_source_y[0] = -0.075;
    wave_source_y[1] = 0.025;
    wave_source_y[2] = 0.245;
    wave_source_y[3] = 0.22;
    wave_source_y[4] = -0.21;
    wave_source_y[5] = 0.0;
    wave_source_y[6] = 0.0;
...
#define LAMBDA 1.0	    /* parameter controlling the dimensions of domain */
#define MU 0.00875           /* parameter controlling the dimensions of domain */
#define MU_B 1.0            /* parameter controlling the dimensions of domain */
...
#define OSCILLATING_SOURCE_PERIOD 5     /* period of oscillating source */
...
### 28 July 2024 - Waves in shallow water with cube-like symmetry on the sphere ###
...
```
    init_linear_blob_sphere(0, 3.8, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 4.2 - PI/3.0, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 3.8 - DPI/3.0, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 4.2 - PI, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 3.8 - 2.0*DPI/3.0, 1.3*PID, -1.0, 0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 4.2 - 5.0*PI/3.0, 0.7*PID, 1.0, -0.25, 0.02, 0.3, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
...
#define PRESSURE_SHIFT 10.0        /* shift for color scheme Z_EULER_PRESSURE */
#define PRESSURE_LOG_SHIFT -2.5     /* shift for color scheme Z_EULER_PRESSURE */
#define VSCALE_WATER_HEIGHT 50.0     /* vertical scaling of water height */
#define ADD_HEIGHT_CONSTANT -0.1   /* constant added to wave height */
#define SHADE_SCALE_2D 0.25     /* controls "depth" of 2D shading */
...
#define PRESSURE_SHIFT 10.0        /* shift for color scheme Z_EULER_PRESSURE */
#define PRESSURE_LOG_SHIFT -2.5     /* shift for color scheme Z_EULER_PRESSURE */
#define VSCALE_WATER_HEIGHT 100.0     /* vertical scaling of water height */
#define ADD_HEIGHT_CONSTANT -0.1   /* constant added to wave height */
#define SHADE_SCALE_2D 0.25     /* controls "depth" of 2D shading */
...
### 27 July 2024 - Growing quasicrystals from pentagons at higher temperature - Energy and orientation ###
...
#define REACTION_DIFFUSION 1      /* set to 1 to simulate a chemical reaction (particles may change type) */
#define RD_REACTION 261           /* type of reaction, see list in global_ljones.c */
#define RD_TYPES 1                /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 0         /* initial condition of particles */
#define REACTION_DIST 1.2         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.075            /* max orientation difference for pairing polygons */
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define EXOTHERMIC 0            /* set to 1 to make reaction exo/endothermic */
#define DELTA_EKIN 2000.0       /* change of kinetic energy in reaction */
#define COLLISION_TIME 25       /* time during which collisions are shown */
#define COLLISION_RADIUS 2.0    /* radius of discs showing collisions, in units of MU */
#define DELTAVMAX 100.0         /* maximal deltav allowed for pairing molecules */
#define AGREGMAX 6              /* maximal number of partners for CHEM_AGGREGATION reaction */
#define AGREG_DECOUPLE 12       /* minimal number of partners to decouple from thermostat */
#define CLUSTER_PARTICLES 1     /* set to 1 for particles to form rigid clusters */
#define CLUSTER_MAXSIZE 500     /* max size of clusters */
#define SMALL_CLUSTER_MAXSIZE 10 /* size limitation on smaller cluster */
#define SMALL_NP_MAXSIZE 2      /* limitation on number of partners of particle in smaller cluster */
...
### 26 July 2024 - Waves escaping a ring of obstacles: logarithmic spirals ###
...
#define CIRCLE_PATTERN 204   /* pattern of circles or polygons, see list in global_pdes.c */
...
#define LOG_SCALE 1.25     /* scaling factor for energy log representation */
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
...
### 25 July 2024 - Four waves in shallow water on the sphere ###
...
```
    init_linear_blob_sphere(0, 3.8, 1.2*PID, -0.8, 0.2, 0.02, 0.25, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 4.2 - PID, 0.8*PID, 0.8, -0.2, 0.02, 0.25, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 3.8 - PI, 1.2*PID, -0.8, 0.2, 0.02, 0.25, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 4.2 - 3.0*PID, 0.8*PID, 0.8, -0.2, 0.02, 0.25, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
...
#define ZSHIFT_SPEED 0.0        /* additional shift of z-coord Z_EULER_SPEED and Z_SWATER_SPEED */
#define ZSCALE_NORMGRADIENT -0.0001  /* vertical scaling for Z_NORM_GRADIENT */
#define VSCALE_SWATER 500.0        /* additional scaling factor for color scheme Z_EULER_DENSITY */
...
#define ROTATE_VIEW 1       /* set to 1 to rotate position of observer */
#define ROTATE_ANGLE 60.0   /* total angle of rotation during simulation */
#define SHADE_3D 0              /* set to 1 to change luminosity according to normal vector */
#define SHADE_2D 1              /* set to 1 to change luminosity according to normal vector */
#define VIEWPOINT_TRAJ 1    /* type of viewpoint trajectory */
#define MAX_LATITUDE 45.0   /* maximal latitude for viewpoint trajectory VP_ORBIT2 */
...
#define PRESSURE_SHIFT 10.0        /* shift for color scheme Z_EULER_PRESSURE */
#define PRESSURE_LOG_SHIFT -2.5     /* shift for color scheme Z_EULER_PRESSURE */
#define VSCALE_WATER_HEIGHT 500.0     /* vertical scaling of water height */
#define ADD_HEIGHT_CONSTANT -0.1   /* constant added to wave height */
#define SHADE_SCALE_2D 0.25     /* controls "depth" of 2D shading */
...
#define VSCALE_VORTICITY 15.0     /* additional scaling factor for color scheme Z_EULERC_VORTICITY */
#define VORTICITY_SHIFT 0.0     /* vertical shift of vorticity */
#define ZSCALE_SPEED 2000.0        /* additional scaling factor for z-coord Z_EULER_SPEED and Z_SWATER_SPEED */
#define ZSHIFT_SPEED 0.0        /* additional shift of z-coord Z_EULER_SPEED and Z_SWATER_SPEED */
#define ZSCALE_NORMGRADIENT -0.0001  /* vertical scaling for Z_NORM_GRADIENT */
#define VSCALE_SWATER 500.0        /* additional scaling factor for color scheme Z_EULER_DENSITY */
...
### 24 July 2024 - Growing quasicrystals from pentagons at higher temperature ###
...
#define PLOT 19
#define PLOT_B 20        /* plot type for second movie */
...
### 23 July 2024 - Waves escaping a sunflower spiral of obstacles ###
...
### 22 July 2024 - Growing quasicrystals from pentagons in a central gravity field ###
...
#define INITXMIN -2.3
#define INITXMAX 2.3	/* x interval for initial condition */
#define INITYMIN -2.3
#define INITYMAX 2.3	/* y interval for initial condition */
...
#define BCYMIN -3.0
#define BCYMAX 3.0	/* y interval for boundary condition */
...
#define COLOR_PALETTE_CLUSTER_SIZE 14 /* Color palette for cluster size representation */
...
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
#define V_INITIAL 50.0        /* initial velocity range */
#define OMEGA_INITIAL 0.0        /* initial angular velocity range */
#define VICSEK_VMIN 1.0    /* minimal speed of particles in Vicsek model */
#define VICSEK_VMAX 40.0    /* minimal speed of particles in Vicsek model */
#define COULOMB_LJ_FACTOR 1.0   /* relative intensity of LJ interaction in I_COULOMB_LJ interaction (default: 0.01) */
...
### 21 July 2024 - Bloopers 18: Numerical blow-up in the shallow water equation on the sphere ###
...
#define BZF 1.2         /* parameter in BZ equation */
#define B_FIELD 10.0    /* magnetic field */
#define G_FIELD 0.005   /* gravity/Coriolis force */
#define BC_FIELD 1.0e-5     /* constant in repulsive field from obstacles */
#define AB_RADIUS 0.2   /* radius of region with magnetic field for Aharonov-Bohm effect */
#define K_EULER 50.0    /* constant in stream function integration of Euler equation */
#define K_EULER_INC 0.5    /* constant in incompressible Euler equation */
...
### 20 July 2024 - Growing quasicrystals from pentagons: Orientation and number of neighbors ###
...
#define COLOR_PALETTE_PRESSURE 11    /* Color palette for different neighbours representation */
#define COLOR_PALETTE_CHARGE 18      /* Color palette for charge representation */
#define COLOR_PALETTE_CLUSTER 10     /* Color palette for cluster representation */
#define COLOR_PALETTE_CLUSTER_SIZE 14 /* Color palette for cluster size representation */
...
#define COUPLE_ANGLE_TO_THERMOSTAT 0    /* set to 1 to couple angular degrees of freedom to thermostat */
#define DIMENSION_FACTOR 1.0  /* scaling factor taking into account number of degrees of freedom */  
#define KTORQUE 2.0e6         /* force constant in angular dynamics */
#define KTORQUE_BOUNDARY 5.0e5  /* constant in torque from the boundary */
#define KTORQUE_B 10.0        /* force constant in angular dynamics */
#define KTORQUE_DIFF 500.0    /* force constant in angular dynamics for different particles */
#define DRAW_SPIN 0           /* set to 1 to draw spin vectors of particles */
...
#define AGREG_DECOUPLE 12       /* minimal number of partners to decouple from thermostat */
#define CLUSTER_PARTICLES 1     /* set to 1 for particles to form rigid clusters */
#define CLUSTER_MAXSIZE 200     /* max size of clusters */
...
### 19 July 2024 - Waves escaping a ring of obstacles: Polar grid ###
...
### 18 July 2024 - Growing quasicrystals by dynamic aggregation of pentagons ###
...
#define PLOT 19
#define PLOT_B 132        /* plot type for second movie */
...
### 17 July 2024 - The shallow water equation on the sphere ###
...
```
    init_linear_blob_sphere(0, 3.8, PID, -0.2, 0.0, 0.02, 0.25, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
    init_linear_blob_sphere(1, 4.2 - PID, PID, 0.2, 0.0, 0.02, 0.25, 0.5, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);
```
...
#define ADD_POTENTIAL_TO_Z 0    /* set to 1 to add the external potential to z-coordinate of plot */
#define ADD_POT_CONSTANT 0.35   /* constant added to wave height */
#define ADD_HEIGHT_CONSTANT 0.0   /* constant added to wave height */
#define DRAW_DEPTH 0            /* set to 1 to draw water depth */
#define DEPTH_SCALE 0.75         /* vertical scaling of depth plot */
#define DEPTH_SHIFT -0.015      /* vertical shift of depth plot */
...
#define CURL_SCALE 1.0   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define SLOPE_SCHROD_LUM 1.0e4       /* sensitivity of luminosity on module, for color scheme Z_ARGUMENT */
#define MIN_SCHROD_LUM 0.1       /* minimal luminosity in color scheme Z_ARGUMENT*/
#define VSCALE_PRESSURE 2.0      /* additional scaling factor for color scheme Z_EULER_PRESSURE */
#define PRESSURE_SHIFT 10.0        /* shift for color scheme Z_EULER_PRESSURE */
#define PRESSURE_LOG_SHIFT -2.5     /* shift for color scheme Z_EULER_PRESSURE */
#define VSCALE_WATER_HEIGHT 5000.0     /* vertical scaling of water height */
#define SHADE_SCALE_2D 0.25     /* controls "depth" of 2D shading */
...
#define ZSHIFT_SPEED 0.0        /* additional shift of z-coord Z_EULER_SPEED and Z_SWATER_SPEED */
#define ZSCALE_NORMGRADIENT -0.0001  /* vertical scaling for Z_NORM_GRADIENT */
#define VSCALE_SWATER 3000.0        /* additional scaling factor for color scheme Z_EULER_DENSITY */
...
#define RSCALE 1000.0             /* scaling factor of radial component */
#define RSHIFT -0.01           /* shift in radial component */
#define RMAX 5000.0               /* max value of radial component */
#define RMIN 0.5               /* min value of radial component */
#define COS_VISIBLE -0.3        /* limit on cosine of normal to shown facets */
...
#define ZSHIFT_SPEED 0.0        /* additional shift of z-coord Z_EULER_SPEED and Z_SWATER_SPEED */
#define ZSCALE_NORMGRADIENT -0.0001  /* vertical scaling for Z_NORM_GRADIENT */
#define VSCALE_SWATER 1000.0        /* additional scaling factor for color scheme Z_EULER_DENSITY */
...
### 16 July 2024 - Mega-hextris: coagulating falling hexagons ###
...
#define RD_TYPES 1                /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 0         /* initial condition of particles */
#define REACTION_DIST 1.3         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.075            /* max orientation difference for pairing polygons */
...
### 15 July 2024 - Waves escaping a ring of obstacles: Poisson disc grid ###
...
#define CIRCLE_PATTERN 203   /* pattern of circles or polygons, see list in global_pdes.c */
...
### 14 July 2024 - Mega-tetris: coagulating falling squares ###
...
### 13 July 2024 - Waves escaping a ring of obstacles: Sunflower grid ###
...
#define P_PERCOL 0.15       /* probability of having a circle in C_RAND_PERCOL arrangement */
#define NPOISSON 1000       /* number of points for Poisson C_RAND_POISSON arrangement */
#define PDISC_FACTOR 6.0    /* controls density of Poisson disc process (default: 3.25) */
#define RANDOM_POLY_ANGLE 1 /* set to 1 to randomize angle of polygons */
...
### 12 July 2024 - Coagulating falling hexagons ###
...
#define DAMPING 250.0          /* damping coefficient of particles */
#define INITIAL_DAMPING 5000.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 100.0      /* damping coefficient for rotation of particles */
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0   /* mass of particle of radius MU_B */
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.0025          /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 1.0e9    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0        /* radius in which to count neighbours */
...
#define RD_TYPES 1                /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 0         /* initial condition of particles */
#define REACTION_DIST 1.1         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.1            /* max orientation difference for pairing polygons */
...
### 11 July 2024 - Waves escaping a ring-shaped domain: Hex grid of obstacles ###
...
### 10 July 2024 - Coagulating falling squares ###
...
#define REACTION_DIFFUSION 1      /* set to 1 to simulate a chemical reaction (particles may change type) */
#define RD_REACTION 26           /* type of reaction, see list in global_ljones.c */
#define RD_TYPES 1                /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 0         /* initial condition of particles */
#define REACTION_DIST 1.4         /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.1              /* max orientation difference for pairing polygons */
...
### 09 July 2024 - Waves branching through Poisson disc obstacles ###
...
### 08 July 2024 - Falling hexagons are falling bestagons ###
...
#define EQUILIBRIUM_DIST_B 2.5  /* Lennard-Jones equilibrium distance for second type of particle */
#define REPEL_RADIUS 25.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 50000.0          /* damping coefficient of particles */
#define INITIAL_DAMPING 5000.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 50.0      /* damping coefficient for rotation of particles */
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0   /* mass of particle of radius MU_B */
...
### 07 July 2024 - Almost a branched flow: waves crossing a finer percolation arrangement ###
...
#define CIRCLE_PATTERN 3   /* pattern of circles or polygons, see list in global_pdes.c */
...
### 06 July 2024 - Falling pentagons pretending to be bestagons ###
...
### 05 July 2024 - Waves crossing a less dense percolation-style arrangement of obstacles ###
...
#define NGRIDY 50           /* number of grid point for grid of disks */
#define WALL_WIDTH 0.1      /* width of wall separating lenses */
...
### 03 July 2024 - Waves from a point source crossing a percolation-style arrangement of obstacles ###
...
### 02 July 2024 - Falling triangles ###
...
### 01 July 2024 - When waves crossing a square lattice have a larger phase than group velocity ###
