...
### 31 May 2024 - Energy flux of waves of two different frequencies crossing a diffraction grating ###
...
#define IOR 19              /* choice of index of refraction, see list in global_pdes.c */
...
#define LAMBDA 0.06	    /* parameter controlling the dimensions of domain */
...
#define FLUX_SCALE 5.0e2    /* scaling factor for energy flux represtnation */
...
#define WAVE_PROFILE_X 1.95      /* value of x to sample wave profile */
...
### 30 May 2024 - Neutral soap and water with increasing force constant ###
...
### 29 May 2024 - Weather on the Earth, with 17 pressure systems ###
...
```
    ...
    init_vortex_state_sphere_mod(0, 0.5, 2.5*PID, PID + 0.5, 0.02, 0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.3, 3.7*PID, PID + 0.7, 0.03, 0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.05, 2.5*PID, PID + 1.3, 0.01, 0.01, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.1, 1.0*PID, PID + 1.0, 0.03, 0.02, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.05, 3.0*PID, 0.9*PI, 0.01, 0.01, phi, xy_in, wsphere);
    /* low pressure systems, northern hemisphere */
    init_vortex_state_sphere_mod(1, -0.25, 3.0*PID, PID + 0.6, 0.03, -0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.2, 2.3*PID, PID + 0.9, 0.01, -0.02, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.25, 1.2*PID, PID + 0.4, 0.01, -0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.5, 0.3*PID, PID + 0.6, 0.01, -0.04, phi, xy_in, wsphere);
    /* high pressure systems, southern hemisphere */
    init_vortex_state_sphere_mod(1, -0.2, 2.4*PID, PID - 0.7, 0.03, 0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.3, 1.6*PID, PID - 0.7, 0.02, 0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.2, 0.5*PID, PID - 0.7, 0.02, 0.04, phi, xy_in, wsphere);
   /* low pressure systems, southern hemisphere */
    init_vortex_state_sphere_mod(1, 0.25, 3.4*PID, PID - 0.7, 0.03, -0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.1, 2.0*PID, PID - 0.1, 0.04, -0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.15, 1.0*PID, PID - 0.6, 0.03, -0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.3, 0.1*PID, PID - 0.5, 0.03, -0.04, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.1, 0.1*PID, 0.1, 0.1, -0.01, phi, xy_in, wsphere);
...
#define BC_STIFFNESS 5.0        /* controls region of boundary condition control */
...
#define RSHIFT -1.5           /* shift in radial component */
...
### 28 May 2024 - Cherenkov radiation for increasing wave speed ###
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.0       /* Courant number */
...
#define WAVE_PROFILE_Y 0.07    /* value of y to sample wave profile */
#define PROFILE_AT_BOTTOM 1     /* draw wave profile at bottom instead of top */
...
### 27 May 2024 - Have you ever questioned the nature of your reality? First successful DNA replication in silico ###
...
#define INITXMIN -1.01
#define INITXMAX 1.01	/* x interval for initial condition */
#define INITYMIN -0.15
...
#define ADD_INITIAL_PARTICLES 1 /* set to 1 to add a second type of particles */
#define CIRCLE_PATTERN_B 0  /* pattern of circles for additional particles */
...
#define MANDELLIMIT 10.0    /* limit value for approximation of Mandelbrot set */
#define FOCI 1              /* set to 1 to draw focal points of ellipse */
#define NGRIDX 31           /* number of grid point for grid of disks */
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.0015           /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 2.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0        /* radius in which to count neighbours */
...
#define ADD_BFIELD 0     /* set to 1 to add a magnetic field */
#define BFIELD 2.666666667       /* value of magnetic field */
#define CHARGE 1.05       /* charge of particles of first type */
...
#define PAIR_SAFETY_FACTOR 1.2  /* distance to deactivate divided by sum of radii */
#define KSPRING_PAIRS 2.25e10    /* spring constant for pair interaction */
#define KTORQUE_PAIRS 1.0e10   /* constant for angular coupling in pair interaction */
#define KTORQUE_PAIR_ANGLE 0.0    /* constant for coupling between orientation in pairs */
#define NPARTNERS 10          /* number of partners of particles */
...
#define HASHY 72      /* size of hashgrid in y direction */
#define HASHMAX 100   /* maximal number of particles per hashgrid cell */
#define HASHGRID_PADDING 0.1    /* padding of hashgrid outside simulation window */
...
### 26 May 2024 - Video #1200: Weather on the Earth ###
...
```
    init_vortex_state_sphere_mod(0, 0.5, 2.5*PID, PID + 0.6, 0.05, 0.08, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.5, 0.0*PID, PID + 0.6, 0.06, -0.08, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.5, 1.0*PID, PID - 0.6, 0.05, 0.08, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.5, 2.2*PID, PID - 0.8, 0.06, -0.08, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.5, 3.5*PID, PID - 0.6, 0.06, 0.08, phi, xy_in, wsphere);
```
...
#define RSCALE 1.0001            /* scaling factor of radial component */
#define RSHIFT -1.0001          /* shift in radial component */
#define RMAX 2.0               /* max value of radial component */
#define RMIN 0.5               /* min value of radial component */
#define COS_VISIBLE -1.1       /* limit on cosine of normal to shown facets */
...
### 25 May 2024 - Waves of two different frequencies crossing a diffraction grating ###
...
### 24 May 2024 - Bloopers 17: You look lonely. I can fix that - Replicating DNA getting pinned ###
...
### 23 May 2024 - Four interacting pressure systems on a rotating sphere ###
...
```
    init_vortex_state_sphere_mod(0, -0.5, 1.0*PID, PID + 0.6, 0.12, 0.08, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.5, 3.0*PID, PID + 0.6, 0.12, -0.08, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.5, 1.5*PID, PID - 0.6, 0.12, 0.08, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.5, 3.5*PID, PID - 0.6, 0.12, -0.08, phi, xy_in, wsphere);
...
#define LOG_SHIFT 1.0   
#define LOG_MIN 1.0e-3   /* floor value for log vorticity plot */
#define VSCALE_SPEED 45.0      /* additional scaling factor for color scheme Z_EULER_SPEED */
...
#define RSCALE 3.0            /* scaling factor of radial component */
...
**Parts 2 and 3 (density and direction 2D):** 
...
#define RSCALE 3.0            /* scaling factor of radial component */
#define RSHIFT -3.0             /* shift in radial component */
#define RMAX 2.0               /* max value of radial component */
#define RMIN 0.5               /* min value of radial component */
#define COS_VISIBLE -1.1       /* limit on cosine of normal to shown facets */
...
**Parts 5 and 6 (density and direction 3D):** 
...
### 22 May 2024 - Cherenkov radiation, with corrected refractive index ###
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.14       /* Courant number */
...
#define PHASE_SHIFT 0.0      /* shift of phase in color scheme P_3D_PHASE */
#define ATTENUATION 0.0   /* exponential attenuation coefficient of contrast with time */
#define E_SCALE 33.0      /* scaling factor for energy representation */
#define LOG_SCALE 1.0     /* scaling factor for energy log representation */
#define LOG_SHIFT 0.5     /* shift of colors on log scale */
#define FLUX_SCALE 5.0e3    /* scaling factor for energy flux represtnation */
#define AVRG_E_FACTOR 0.95   /* controls time window size in P_AVERAGE_ENERGY scheme */
...
#define VERTICAL_WAVE_PROFILE 0 /* set to 1 to draw wave profile vertically */
#define WAVE_PROFILE_X 1.6      /* value of x to sample wave profile */
#define WAVE_PROFILE_Y -0.05    /* value of y to sample wave profile */
#define PROFILE_AT_BOTTOM 1     /* draw wave profile at bottom instead of top */
#define AVERAGE_WAVE_PROFILE 0  /* set to 1 to draw time-average of wave profile squared*/
#define DRAW_WAVE_TIMESERIES 0  /* set to 1 to draw a time series of the wave, 2 to also draw it at the top */
#define TIMESERIES_NVALUES 400  /* number of values plotted in time series */
...
### 21 May 2024 - A and C and T and G. The alphabet of you: Almost complete DNA replication ###
...
```
    if (ADD_INITIAL_PARTICLES) 
    {
        add_particle_config(particle, INITXMIN - 0.3, INITXMAX + 0.3, INITYMAX + 0.1, YMAX-0.1, NGRIDX, 3, 0, MU);
        add_particle_config(particle, INITXMIN - 0.3, INITXMAX + 0.3, YMIN + 0.1, INITYMIN-0.1, NGRIDX, 3, 0, MU);
    }
```
...
#define INITXMIN -0.81
#define INITXMAX 0.81	/* x interval for initial condition */
#define INITYMIN -0.15
#define INITYMAX 0.15	/* y interval for initial condition */
...
#define ADDXMIN -1.1
#define ADDXMAX 1.1	/* x interval for adding particles */
#define ADDYMIN -1.0
#define ADDYMAX 1.0	/* y interval for adding particles */
#define ADDRMIN 4.75 
#define ADDRMAX 6.0     /* r interval for adding particles */
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.0011           /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 2.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0        /* radius in which to count neighbours */
...
#define ADD_BFIELD 0     /* set to 1 to add a magnetic field */
#define BFIELD 2.666666667       /* value of magnetic field */
#define CHARGE 1.25      /* charge of particles of first type */
#define CHARGE_B 0.0     /* charge of particles of second type */
#define INCREASE_E 0     /* set to 1 to increase electric field */
#define EFIELD_FACTOR 5000000.0    /* factor by which to increase electric field */
#define INCREASE_B 0     /* set to 1 to increase magnetic field */
...
#define TS_SLOPE 8.0          /* controls speed of change of BETA for TS_TANH schedule (default 1.0) */
#define N_TOSCILLATIONS 1.0   /* number of temperature oscillations in BETA schedule */
#define NO_OSCILLATION 0        /* set to 1 to have exponential BETA change only */
#define MIDDLE_CONSTANT_PHASE 0   /* final phase in which temperature is constant */
#define FINAL_DECREASE_PHASE 0    /* final phase in which temperature decreases */ 
...
#define ADD_TIME 50       /* time at which to add first particle */
#define ADD_PERIOD 2       /* time interval between adding further particles */
#define N_ADD_PARTICLES 6  /* number of particles to add */
#define FINAL_NOADD_PERIOD 7700  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
#define RD_TYPES 6                /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 10        /* initial condition of particles */
#define REACTION_DIST 3.18        /* maximal distance for reaction to occur */
#define REACTION_PROB 0.75        /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.001        /* probability of enzymes being killed */
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define EXOTHERMIC 0            /* set to 1 to make reaction exo/endothermic */
#define DELTA_EKIN 2000.0       /* change of kinetic energy in reaction */
#define COLLISION_TIME 25      /* time during which collisions are shown */
#define DELTAVMAX 400.0         /* maximal deltav allowed for pairing molecules */
#define AGREGMAX 11              /* maximal number of partners for CHEM_AGGREGATION reaction */
#define AGREG_DECOUPLE 12        /* minimal number of partners to decouple from thermostat */
...
### 20 May 2024 - Density and direction of velocity for more stable vortices on a rotating sphere ###
...
```
    init_vortex_state_sphere_mod(0, -0.5, 1.0*PID, PID + 0.6, 0.12, 0.1, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.5, 3.0*PID, PID + 0.6, 0.12, -0.1, phi, xy_in, wsphere);
```
...
### 19 May 2024 - Cherenkov radiation of an even faster particle ###
...
```
    ...
    wave_source_x = XMIN + 1.4*(XMAX-XMIN)*(double)i/(double)NSTEPS;
    wave_source_y = 0.0;
    if ((ADD_OSCILLATING_SOURCE)&&(i%OSCILLATING_SOURCE_PERIOD == 1))
    {
        if (ALTERNATE_OSCILLATING_SOURCE) sign = -sign;
        add_circular_wave(sign*INITIAL_AMP, wave_source_x, wave_source_y, phi, psi, xy_in);
    }
```
...
### 18 May 2024 - enhance 57-19: DNA replication (short version) ###
...
#define INITYMIN -0.16
#define INITYMAX 0.16	/* y interval for initial condition */
...
#define SLEEP1  1        /* initial sleeping time */
#define SLEEP2  1   /* final sleeping time */
#define MID_FRAMES 0    /* number of still frames between parts of two-part movie */
#define END_FRAMES 100   /* number of still frames at end of movie */
...
#define ADD_TIME 50       /* time at which to add first particle */
#define ADD_PERIOD 2       /* time interval between adding further particles */
#define N_ADD_PARTICLES 4  /* number of particles to add */
#define FINAL_NOADD_PERIOD 2700  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
#define REACTION_DIFFUSION 1      /* set to 1 to simulate a chemical reaction (particles may change type) */
#define RD_REACTION 255           /* type of reaction, see list in global_ljones.c */
#define RD_TYPES 6                /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 10        /* initial condition of particles */
#define REACTION_DIST 3.18        /* maximal distance for reaction to occur */
#define REACTION_PROB 0.75        /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0005       /* probability of enzymes being killed */
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define EXOTHERMIC 0            /* set to 1 to make reaction exo/endothermic */
#define DELTA_EKIN 2000.0       /* change of kinetic energy in reaction */
#define COLLISION_TIME 25      /* time during which collisions are shown */
...
### 17 May 2024 - Density, speed and vorticity of unstable vortices on the sphere, featuring music be State Azure ###
...
```
    init_vortex_state_sphere_mod(0, -0.3, 0.5*PID, PID + 0.5, 0.1, 0.2, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.3, 1.5*PID, PID - 0.5, 0.1, -0.2, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.25, 2.5*PID, PID + 0.4, 0.12, -0.15, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.25, 3.5*PID, PID - 0.4, 0.12, 0.15, phi, xy_in, wsphere);
```
...
#define RSCALE 3.5             /* scaling factor of radial component */
#define RMAX 2.0               /* max value of radial component */
#define RMIN 0.5               /* min value of radial component */
#define COS_VISIBLE -1.1       /* limit on cosine of normal to shown facets */
...
### 16 May 2024 -Cherenkov radiation of a faster particle  ###
...
### 15 May 2024 - Within cells interlinked: Replicated DNA curling up in a box ###
...
#define INITXMIN -1.62
#define INITXMAX 1.62	/* x interval for initial condition */
#define INITYMIN -0.16
#define INITYMAX 0.16	/* y interval for initial condition */
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.000677           /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 2.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0        /* radius in which to count neighbours */
...
#define TS_SLOPE 3.0          /* controls speed of change of BETA for TS_TANH schedule (default 1.0) */
#define N_TOSCILLATIONS 1.0   /* number of temperature oscillations in BETA schedule */
#define NO_OSCILLATION 0        /* set to 1 to have exponential BETA change only */
#define MIDDLE_CONSTANT_PHASE 0   /* final phase in which temperature is constant */
#define FINAL_DECREASE_PHASE 0    /* final phase in which temperature decreases */ 
...
#define N_ADD_PARTICLES 4  /* number of particles to add */
#define FINAL_NOADD_PERIOD 10000  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
### 14 May 2024 - Adding tracers in 3D to vortex simulations on a rotating sphere ###
...
```
    init_vortex_state_sphere_mod(0, -0.25, 0.5*PID, PID + 0.5, 0.1, 0.12, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.25, 1.5*PID, PID - 0.5, 0.1, 0.12, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.2, 2.5*PID, PID + 0.4, 0.12, 0.11, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.2, 3.5*PID, PID - 0.4, 0.12, 0.11, phi, xy_in, wsphere);
...
### 13 May 2024 - Cherenkov radiation ###
...
```
    ...
    wave_source_x = XMIN + (XMAX-XMIN)*(double)i/(double)NSTEPS;
    wave_source_y = 0.0;
    if ((ADD_OSCILLATING_SOURCE)&&(i%OSCILLATING_SOURCE_PERIOD == 1))
    {
        if (ALTERNATE_OSCILLATING_SOURCE) sign = -sign;
...
#define VERTICAL_WAVE_PROFILE 0 /* set to 1 to draw wave profile vertically */
#define WAVE_PROFILE_X 1.6      /* value of x to sample wave profile */
#define WAVE_PROFILE_Y -0.1      /* value of y to sample wave profile */
#define PROFILE_AT_BOTTOM 1     /* draw wave profile at bottom instead of top */
#define AVERAGE_WAVE_PROFILE 0  /* set to 1 to draw time-average of wave profile squared*/
#define DRAW_WAVE_TIMESERIES 0  /* set to 1 to draw a time series of the wave, 2 to also draw it at the top */
#define TIMESERIES_NVALUES 400  /* number of values plotted in time series */
...
### 12 May 2024 - All those moments will be lost in time: Longer simulation of DNA replication ###
...
#define INCREASE_BETA 1  /* set to 1 to increase BETA during simulation */
#define BETA_SCHEDULE 8    /* type of temperature schedule, see TS_* in global_ljones */
#define BETA_FACTOR 0.12    /* factor by which to change BETA during simulation */
#define TS_SLOPE 3.0          /* controls speed of change of BETA for TS_TANH schedule (default 1.0) */
#define N_TOSCILLATIONS 1.0   /* number of temperature oscillations in BETA schedule */
#define NO_OSCILLATION 0        /* set to 1 to have exponential BETA change only */
#define MIDDLE_CONSTANT_PHASE 0   /* final phase in which temperature is constant */
...
#define FINAL_NOADD_PERIOD 8000  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
### 11 May 2024 - More stable vortices in Euler’s equations on a rotating sphere ###
...
```
    init_vortex_state_sphere_mod(0, -0.2, 0.5*PID, PID + 0.5, 0.1, 0.1, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.2, 1.5*PID, PID - 0.5, 0.1, 0.1, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, -0.18, 2.5*PID, PID + 0.4, 0.12, 0.11, phi, xy_in, wsphere);
    init_vortex_state_sphere_mod(1, 0.18, 3.5*PID, PID - 0.4, 0.12, 0.11, phi, xy_in, wsphere);
...
### 10 May 2024 - Waves of two different frequencies crossing a biconvex lens ###
...
```
    ...
    {
        if (ALTERNATE_OSCILLATING_SOURCE) sign1 = -sign1;
        add_circular_wave(sign1*INITIAL_AMP/sqrt(3.0), wave_source_x, -wave_source_y, phi, psi, xy_in);
    }
...
### 09 May 2024 - Replicants are like any other machine: Trying to model DNA replication ###
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.0007           /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 2.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0        /* radius in which to count neighbours */
...
#define ADD_PERIOD 7       /* time interval between adding further particles */
#define N_ADD_PARTICLES 2  /* number of particles to add */
#define FINAL_NOADD_PERIOD 5000  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
### 08 May 2024 - The asymmetric Rock-Paper-Scissors-Lizard-Spock equation on the sphere, with improved polar behavior ###
...
#define DSMOOTH 1       /* size of neighbourhood of poles that are smoothed */
#define SMOOTHPOLE 0.065  /* smoothing coefficient at poles */
#define PHISHIFT 0.0    /* shift of phi in 2D plot (in degrees) */
#define SMOOTHBLOCKS 1  /* set to 1 to use blocks of points near the poles */
...
#define RPSLZB_CHANGE 0.75      /* factor by which to rpslzb parameter */
#define RPSLZB_INITIAL_TIME 0   /* initial time during which rpslzb remains constant */
#define RPSLZB_FINAL_TIME 250   /* final time during which rpslzb remains constant */
...
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
#define CURL_SCALE .0   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define SLOPE_SCHROD_LUM 100.0       /* sensitivity of luminosity on module, for color scheme Z_ARGUMENT */
#define MIN_SCHROD_LUM 0.1       /* minimal luminosity in color scheme Z_ARGUMENT*/
#define VSCALE_PRESSURE 2.0      /* additional scaling factor for color scheme Z_EULER_PRESSURE */
...
#define RSCALE 0.004           /* scaling factor of radial component */
...
### 07 May 2024 - Unzipping more flexible DNA-like molecules using enzymes ###
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.0004           /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 2.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0        /* radius in which to count neighbours */
...
#define ADD_PERIOD 7       /* time interval between adding further particles */
#define N_ADD_PARTICLES 2  /* number of particles to add */
#define FINAL_NOADD_PERIOD 3000  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
### 06 May 2024 - A light source approaching a biconvex lens ###
...
```
    ...
    if ((ADD_OSCILLATING_SOURCE)&&(i%OSCILLATING_SOURCE_PERIOD == 1))
    {
        ...
        wave_source_x = XMIN + time*(-XMIN);
        wave_source_y = 0.0;
        add_circular_wave(sign, wave_source_x, wave_source_y, phi, psi, xy_in);
    }
    finv = COURANT/COURANTB - 1.0;
    dsource = -(XMIN + ((double)(i-800)/(double)NSTEPS)*(-XMIN));
    focus_x = 1.0/(finv - 1.0/dsource);
```
...
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.1        /* Courant number */
#define COURANTB 0.043      /* Courant number in medium B */
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 0.0         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
#define GAMMA_TOPBOT 1.0e-7     /* damping factor on boundary */
...
#define HORIZONTAL_WAVE_PROFILE 0 /* set to 1 to draw wave profile vertically */
#define VERTICAL_WAVE_PROFILE 1 /* set to 1 to draw wave profile vertically */
#define WAVE_PROFILE_X 1.5      /* value of x to sample wave profile */
#define WAVE_PROFILE_Y -1.0     /* value of y to sample wave profile */
#define PROFILE_AT_BOTTOM 1     /* draw wave profile at bottom instead of top */
#define AVERAGE_WAVE_PROFILE 0  /* set to 1 to draw time-average of wave profile squared*/
#define DRAW_WAVE_TIMESERIES 0  /* set to 1 to draw a time series of the wave, 2 to also draw it at the top */
#define TIMESERIES_NVALUES 400  /* number of values plotted in time series */
#define SAVE_TIME_SERIES 0      /* set to 1 to save wave time series at a point */
#define DRAW_WAVE_SOURCE 2      /* set to 1 to draw source of wave at (wave_source_x, wave_source_y), set to 2 to also draw focus */
...
### 05 May 2024 - Transition from symmetric to asymmetric Rock-paper-scissors-lizard-Spock equation on the sphere ###
...
#define RSCALE 0.002           /* scaling factor of radial component */
#define RMAX 1.5               /* max value of radial component */
#define RMIN 0.75              /* min value of radial component */
#define COS_VISIBLE -0.75       /* limit on cosine of normal to shown facets */
...
### 04 May 2024 - Unzipping DNA molecules with enzymes (a simple model) ###
...
#define VARY_THERMOSTAT 0   /* set to 1 for time-dependent thermostat schedule */
#define SIGMA 5.0           /* noise intensity in thermostat */
#define BETA 0.0003           /* initial inverse temperature */
#define MU_XI 0.005           /* friction constant in thermostat */
#define KSPRING_BOUNDARY 2.0e11    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 2.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 5.0        /* radius in which to count neighbours */
...
### 03 May 2024 - A light source moving between focal points of an ellipse ###
...
```
    ...
    if ((ADD_OSCILLATING_SOURCE)&&(i%OSCILLATING_SOURCE_PERIOD == 1))
    {
        ...
        a = -4.0;
        b = 2.0;
        wave_source_x = sqrt(LAMBDA*LAMBDA - 1.0);
        if ((time > 0.25)&&(time < 0.75)) wave_source_x *= (a*time + b);
        else if (time >= 0.75) wave_source_x *= -1.0;
        wave_source_y = 0.0;
        add_circular_wave(sign, wave_source_x, wave_source_y, phi, psi, xy_in);
    }
```
...
### 02 May 2024 - The Rock-Paper-Scissors-Lizard-Spock equation on the sphere, with Improved behavior at the poles ###
...
#define RSCALE 0.006           /* scaling factor of radial component */
#define RMAX 1.5               /* max value of radial component */
#define RMIN 0.75              /* min value of radial component */
#define COS_VISIBLE -0.75       /* limit on cosine of normal to shown facets */
...
### 01 May 2024 - DNA-like molecules in a box ###
