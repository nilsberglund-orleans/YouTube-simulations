...
### 30 November 2024 - Waves in a domain shaped like an electric guitar ###
...
#define INITIAL_AMP 0.45           /* amplitude of initial condition */
...
### 29 November 2024 - Lattice vibrations in a harmonic crystal hit by a fast particle ###
...
#define OBSTACLE_COUPLING_DIST 0.24  /* max distance of coupled obstacles */
...
#define OBSTACLE_COLOR 2    /* type of obstacle, see OC_ in global_ljones.c */
...
### 28 November 2024 - Waves starting around the sound hole of a guitar-shaped domain ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        wave_source_x[source] = 0.3;
        wave_source_y[source] = 0.05;
        source_shift[source] = 0;
        if ((ADD_OSCILLATING_SOURCE)&&(i%(OSCILLATING_SOURCE_PERIOD) == source_shift[source]))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
...
#define CIRCLE_PATTERN 202   /* pattern of circles or polygons, see list in global_pdes.c */
#define IMAGE_FILE 1        /* for option D_IMAGE */
...
### 27 November 2024 - Pulsing sources with four different phases on the vertices of an octahedron ###
...
### 26 November 2024 - Heating a harmonic crystal with nearest neighbor coupling ###
...
#define ADDXMAX -1.9	/* x interval for adding particles */
#define ADDYMIN 0.2
#define ADDYMAX 0.25	/* y interval for adding particles */
#define ADDRMIN 4.75 
#define ADDRMAX 6.0     /* r interval for adding particles */
...
#define PLOT 13
#define PLOT_B 23        /* plot type for second movie */

/* Background color depending on particle properties */

#define COLOR_BACKGROUND 1  /* set to 1 to color background */
#define BG_COLOR 5          /* type of background coloring, see list in global_ljones.c */
...
#define OBSTACLE_EMAX 30000.0        /* energy of particle with hottest color */
#define HUE_TYPE0 320.0      /* hue of particles of type 0 */
#define HUE_TYPE1 60.0       /* hue of particles of type 1 */
#define HUE_TYPE2 320.0      /* hue of particles of type 2 */
#define HUE_TYPE3 260.0      /* hue of particles of type 3 */
...
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
#define V_INITIAL 250.0        /* initial velocity range */
#define OMEGA_INITIAL 100.0        /* initial angular velocity range */
#define VICSEK_VMIN 1.0    /* minimal speed of particles in Vicsek model */
#define VICSEK_VMAX 40.0    /* minimal speed of particles in Vicsek model */
#define COULOMB_LJ_FACTOR 1.0   /* relative intensity of LJ interaction in I_COULOMB_LJ interaction (default: 0.01) */
...
#define KSPRING_OBSTACLE_OSC 5.0e7   /* spring constant for oscillating obstacles */
#define KSPRING_OBSTACLE_COUPLE 5.0e7   /* spring constant for coupled obstacles */
#define KCOULOMB_OBSTACLE 1000.0   /* Coulomb force constant for charged obstacles */
#define BFIELD_REGION 1          /* space-dependent magnetic field (0 for constant) */
...
### 25 November 2024 - Waves starting near the center of a guitar-shaped domain ###
...
### 24 November 2024 - Pulsing sources with four different phases on the vertices of an icosahedron ###
...
```
    ...
    wave_shift[0] = 0;
    wave_signs[0] = 1.0;
    wave_shift[1] = OSCILLATING_SOURCE_PERIOD/2;
    wave_signs[1] = 1.0;
    wave_shift[2] = 0;
    wave_signs[2] = -1.0;
    wave_shift[3] = OSCILLATING_SOURCE_PERIOD/2;
    wave_signs[3] = -1.0;
    wave_shift[4] = OSCILLATING_SOURCE_PERIOD/2;
    wave_signs[4] = 1.0;
    wave_shift[5] = 0;
    wave_signs[5] = -1.0;
    wave_shift[6] = OSCILLATING_SOURCE_PERIOD/2;
    wave_signs[6] = -1.0;
    wave_shift[7] = 0;
    wave_signs[7] = 1.0;
    wave_shift[8] = 0;
    wave_signs[8] = -1.0;
    wave_shift[9] = OSCILLATING_SOURCE_PERIOD/2;
    wave_signs[9] = -1.0;
    wave_shift[10] = 0;
    wave_signs[10] = 1.0;
    wave_shift[11] = OSCILLATING_SOURCE_PERIOD/2;
    wave_signs[11] = 1.0;
...
#define INITIAL_VARIANCE 0.01     /* variance of initial condition */
#define INITIAL_WAVELENGTH  0.2   /* wavelength of initial condition */
#define N_SOURCES 12              /* number of sources, for option draw_sources */
...
#define AMPLITUDE_HIGH_RES 1    /* set to 1 to increase resolution of plot */
#define SHADE_3D 1              /* set to 1 to change luminosity according to normal vector */
#define SHADE_2D 2              /* set to 1 to change luminosity according to normal vector to plane */
#define SHADE_WAVE 1            /* set to 1 to have luminosity depend on wave height */
#define NON_DIRICHLET_BC 1      /* set to 1 to draw only facets in domain, if field is not zero on boundary */
#define FLOOR_ZCOORD 0          /* set to 1 to draw only facets with z not too negative */
#define DRAW_BILLIARD 0         /* set to 1 to draw boundary */
...
### 23 November 2024 - Heat map of a heat flow through a harmonic crystal ###
...
### 22 November 2024 - Waves in a guitar-shaped domain ###
...
### 21 November 2024 - Pulsing sources in phase ppposition on the vertices of a cube ###
...
```
    ...
    for (j=1; j<4; j++) wave_signs[j] = -1.0;
    wave_signs[ncircles-1] = -1.0;
...
#define INITIAL_AMP 5.0            /* amplitude of initial condition */
...
### 20 November 2024 - Heat flow through a harmonic crystal ###
...
#define PARTICLE_EMIN 100.0          /* energy of particle with coolest color */
#define PARTICLE_EMAX 30000.0       /* energy of particle with hottest color */
#define OBSTACLE_EMAX 12000.0        /* energy of particle with hottest color */
#define HUE_TYPE0 320.0      /* hue of particles of type 0 */
#define HUE_TYPE1 60.0       /* hue of particles of type 1 */
#define HUE_TYPE2 320.0      /* hue of particles of type 2 */
#define HUE_TYPE3 260.0      /* hue of particles of type 3 */
...
### 19 November 2024 - Waves starting from the center of a cardioid ###
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.09       /* Courant number */
#define COURANTB 0.025       /* Courant number in medium B */
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 1.0e-7         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
...
### 18 November 2024 - Heating a crystal with a single fast particle ###
...
#define PARTICLE_EMIN 100.0          /* energy of particle with coolest color */
#define PARTICLE_EMAX 30000.0       /* energy of particle with hottest color */
#define OBSTACLE_EMAX 2000.0        /* energy of particle with hottest color */
#define HUE_TYPE0 320.0      /* hue of particles of type 0 */
#define HUE_TYPE1 60.0       /* hue of particles of type 1 */
#define HUE_TYPE2 320.0      /* hue of particles of type 2 */
#define HUE_TYPE3 260.0      /* hue of particles of type 3 */
...
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
#define V_INITIAL 750.0        /* initial velocity range */
#define OMEGA_INITIAL 100.0        /* initial angular velocity range */
#define VICSEK_VMIN 1.0    /* minimal speed of particles in Vicsek model */
#define VICSEK_VMAX 40.0    /* minimal speed of particles in Vicsek model */
#define COULOMB_LJ_FACTOR 1.0   /* relative intensity of LJ interaction in I_COULOMB_LJ interaction (default: 0.01) */
...
#define CHARGE_OBSTACLES 0      /* set to 1 for obstacles to be charged */
#define OBSTACLE_CHARGE 3.0     /* charge of obstacles */
#define OBSTACLE_MASS 2000.0       /* mass of obstacles, if oscillating */
#define KSPRING_OBSTACLE_OSC 5.0e8   /* spring constant for oscillating obstacles */
#define KCOULOMB_OBSTACLE 1000.0   /* Coulomb force constant for charged obstacles */
#define BFIELD_REGION 1          /* space-dependent magnetic field (0 for constant) */
...
#define N_TRACER_PARTICLES 500    /* number of tracer particles */
#define TRAJECTORY_LENGTH 11700    /* length of recorded trajectory */
#define TRACER_LUM_FACTOR 0.5     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
#define TRAJECTORY_WIDTH 2        /* width of tracer particle trajectory */
...
### 17 November 2024 - Exciting resonant modes in an ellipse with twelve sources in phase opposition ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        ...
        nx *= r;
        ny *= r;
        wave_source_x[source] = x + 2.0*JULIA_SCALE*MU*nx;
        wave_source_y[source] = y + 2.0*JULIA_SCALE*MU*ny;
        if (source%2 == 0) source_shift[source] = 0;
        else source_shift[source] = OSCILLATING_SOURCE_PERIOD/2;
        if ((ADD_OSCILLATING_SOURCE)&&(i%(OSCILLATING_SOURCE_PERIOD) == source_shift[source]))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
            add_circular_wave(-sign[source]*INITIAL_AMP, wave_source_x[source], wave_source_y[source], phi, psi, xy_in);
...
#define B_DOMAIN 794         /* choice of domain shape, see list in global_pdes.c */
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.06144       /* Courant number */
#define COURANTB 0.025       /* Courant number in medium B */
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 1.0e-7         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
...
### 16 November 2024 - Heating a crystal: Version with background heat map ###
...
#define OBSTACLE_CHARGE 3.0     /* charge of obstacles */
#define OBSTACLE_MASS 200.0       /* mass of obstacles, if oscillating */
#define KSPRING_OBSTACLE_OSC 2.0e8   /* spring constant for oscillating obstacles */
#define KCOULOMB_OBSTACLE 1000.0   /* Coulomb force constant for charged obstacles */
#define BFIELD_REGION 1          /* space-dependent magnetic field (0 for constant) */
...
#define TRACER_PARTICLE 0   /* set to 1 to have a tracer particle */
#define N_TRACER_PARTICLES 500    /* number of tracer particles */
#define TRAJECTORY_LENGTH 5050    /* length of recorded trajectory */
#define TRACER_LUM_FACTOR 250.0     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
...
### 15 November 2024 - Pulsing sources on the vertices of an octahedron ###
...
### 14 November 2024 - Waves starting from the cusp of a cardioid ###
...
### 13 November 2024 - Heating a crystal by shooting particles at it ###
...
#define NSTEPS 5050      /* number of frames of movie */
#define NVID 120         /* number of iterations between images displayed on screen */
#define NSEG 25          /* number of segments of boundary of circles */
#define INITIAL_TIME 0     /* time after which to start saving frames */
#define OBSTACLE_INITIAL_TIME 0     /* time after which to start moving obstacle */
...
#define N_TRACER_PARTICLES 500    /* number of tracer particles */
#define TRAJECTORY_LENGTH 5050    /* length of recorded trajectory */
#define TRACER_LUM_FACTOR 180.0     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
#define TRAJECTORY_WIDTH 3        /* width of tracer particle trajectory */
...
### 12 November 2024 - Pulsing sources on the vertices of a cube ###
...
### 11 November 2024 - Exciting resonant modes in an ellipse with six sources ###
...
#define JULIA_SCALE 0.9 /* scaling for Julia sets and some other domains */
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.0691       /* Courant number */
#define COURANTB 0.025       /* Courant number in medium B */
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 1.0e-7         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
...
#define NSTEPS 3550         /* number of frames of movie */
#define NVID 8              /* number of iterations between images displayed on screen */
#define NSEG 1000           /* number of segments of boundary */
#define INITIAL_TIME 0      /* time after which to start saving frames */
#define BOUNDARY_WIDTH 2    /* width of billiard boundary */
...
### 10 November 2024 - A Galton board with wind ###
...
#define INITXMIN -0.05
#define INITXMAX 0.05	/* x interval for initial condition */
...
#define ADDXMIN -0.53
#define ADDXMAX -0.47	/* x interval for adding particles */
#define ADDYMIN 1.13
#define ADDYMAX 1.14	/* y interval for adding particles */
#define ADDRMIN 4.75 
#define ADDRMAX 6.0     /* r interval for adding particles */
...
#define CIRCLE_PATTERN 99  /* pattern of circles, see list in global_ljones.c */

#define ADD_INITIAL_PARTICLES 0 /* set to 1 to add a second type of particles */
#define CIRCLE_PATTERN_B 1  /* pattern of circles for additional particles */

#define ADD_FIXED_OBSTACLES 1   /* set to 1 do add fixed circular obstacles */
#define OBSTACLE_PATTERN 11     /* pattern of obstacles, see list in global_ljones.c */
...
#define SEGMENT_PATTERN 363     /* pattern of repelling segments, see list in global_ljones.c */
#define ROCKET_SHAPE 3        /* shape of rocket combustion chamber, see list in global_ljones.c */
#define ROCKET_SHAPE_B 3      /* shape of second rocket */
#define NOZZLE_SHAPE 6        /* shape of nozzle, see list in global_ljones.c */
#define NOZZLE_SHAPE_B 6      /* shape of nozzle for second rocket, see list in global_ljones.c */
...
#define RANDOM_RADIUS_MIN 0.3    /* min of random particle radius (default 0.75) */
...
#define DT_PARTICLE 3.0e-6    /* time step for particle displacement */
#define KREPEL 50.0          /* constant in repelling force between particles */
#define EQUILIBRIUM_DIST 2.8    /* Lennard-Jones equilibrium distance */
#define EQUILIBRIUM_DIST_B 2.8  /* Lennard-Jones equilibrium distance for second type of particle */
#define SEGMENT_FORCE_EQR 1.0   /* equilibrium distance factor for force from segments (default 1.5) */
#define REPEL_RADIUS 25.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 300.0         /* damping coefficient of particles */
#define INITIAL_DAMPING 1000.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 5.0      /* damping coefficient for rotation of particles */
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0   /* mass of particle of radius MU_B */
...
#define KSPRING_OBSTACLE 1.0e9    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 4.0       /* radius in which to count neighbours */
#define GRAVITY 35000.0            /* gravity acting on all particles */
#define GRAVITY_X 0.0          /* horizontal gravity acting on all particles */
#define CIRCULAR_GRAVITY 0     /* set to 1 to have gravity directed to center */
#define INCREASE_GRAVITY 0     /* set to 1 to increase gravity during the simulation */
#define GRAVITY_SCHEDULE 1     /* type of gravity schedule, see list in global_ljones.c */
...
#define WIND_FORCE 2.25e6    /* force of wind */
#define WIND_YMIN -0.6      /* min altitude of region with wind */
...
#define ADD_REGION 0      /* shape of add regions, cf ADD_* in global_ljones */
#define ADD_TIME 0       /* time at which to add first particle */
#define ADD_PERIOD 11      /* time interval between adding further particles */
#define N_ADD_PARTICLES 1  /* number of particles to add */
#define FINAL_NOADD_PERIOD 500  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
#define TRACER_LUM_FACTOR 20.0     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
#define TRAJECTORY_WIDTH 3        /* width of tracer particle trajectory */
...
### 09 November 2024 - Pulsing sources on the vertices of an icosahedron ###
...
#define RSCALE 1.0              /* scaling factor of radial component */
#define RMAX 1.2               /* max value of radial component */
#define RMIN 0.8               /* min value of radial component */
#define Z_SCALING_FACTOR 0.8   /* overall scaling factor of z axis for REP_PROJ_3D representation */
#define XY_SCALING_FACTOR 2.2   /* overall scaling factor for on-screen (x,y) coordinates after projection */
#define ZMAX_FACTOR 1.0         /* max value of z coordinate for REP_PROJ_3D representation */
#define XSHIFT_3D 0.0           /* overall x shift for REP_PROJ_3D representation */
...
### 08 November 2024 - Exciting resonant modes in an ellipse with four sources ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        ...
        nx *= r;
        ny *= r;
        wave_source_x[source] = x + 2.0*MU*nx;
        wave_source_y[source] = y + 2.0*MU*ny;
        source_shift[source] = 0;
        if ((ADD_OSCILLATING_SOURCE)&&(i%(OSCILLATING_SOURCE_PERIOD) == source_shift[source]))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.0768       /* Courant number */
#define COURANTB 0.025       /* Courant number in medium B */
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 1.0e-7         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
...
### 07 November 2024 - Trajectories in a Galton board ###
...
#define ADDXMIN -0.03
#define ADDXMAX 0.03	/* x interval for adding particles */
#define ADDYMIN 1.1
...
#define ADD_FIXED_OBSTACLES 1   /* set to 1 do add fixed circular obstacles */
#define OBSTACLE_PATTERN 1      /* pattern of obstacles, see list in global_ljones.c */
#define RATTLE_OBSTACLES 1      /* set to 1 to rattle obstacles (for pattern O_SIEVE_B) */

#define ADD_FIXED_SEGMENTS 1    /* set to 1 to add fixed segments as obstacles */
#define SEGMENT_PATTERN 362     /* pattern of repelling segments, see list in global_ljones.c */
#define ROCKET_SHAPE 3        /* shape of rocket combustion chamber, see list in global_ljones.c */
#define ROCKET_SHAPE_B 3      /* shape of second rocket */
#define NOZZLE_SHAPE 6        /* shape of nozzle, see list in global_ljones.c */
#define NOZZLE_SHAPE_B 6      /* shape of nozzle for second rocket, see list in global_ljones.c */
...
#define PARTICLE_HUE_MAX 0.0        /* color of saturated particle */
#define PARTICLE_EMIN 10.0          /* energy of particle with coolest color */
#define PARTICLE_EMAX 40000.0        /* energy of particle with hottest color */
#define HUE_TYPE0 320.0      /* hue of particles of type 0 */
#define HUE_TYPE1 60.0       /* hue of particles of type 1 */
#define HUE_TYPE2 320.0      /* hue of particles of type 2 */
#define HUE_TYPE3 260.0      /* hue of particles of type 3 */
...
### 06 November 2024 - Exciting resonant modes in an ellipse ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        angle = (double)source*PI;
        wave_source_x[source] = (0.9*XMAX - MU)*cos(angle);
        wave_source_y[source] = 0.0;
        source_shift[source] = 0.0;
        if ((ADD_OSCILLATING_SOURCE)&&(i%OSCILLATING_SOURCE_PERIOD == source_shift[source]))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
            add_circular_wave(-sign[source]*INITIAL_AMP, wave_source_x[source], wave_source_y[source], phi, psi, xy_in);
...
#define B_DOMAIN 793        /* choice of domain shape, see list in global_pdes.c */
...
#define APOLY 0.497         /* angle by which to turn polygon, in units of Pi/2 */ 
#define MDEPTH 6            /* depth of computation of Menger gasket */
#define MRATIO 3            /* ratio defining Menger gasket */
#define MANDELLEVEL 1000    /* iteration level for Mandelbrot set */
#define MANDELLIMIT 10.0    /* limit value for approximation of Mandelbrot set */
...
### 05 November 2024 - Blue waves overrunning Florida and Texas – Chixculub_like impact simulation  ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_expanding_blob_sphere(0, (279.0/180.0)*PI, (115.0/180.0)*PI, 0.75, 0.04, 0.06, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);` 
...
### 04 November 2024 - A single tracer particle in a Lorentz gas ###
...
#define PARTICLE_HUE_MAX 0.0        /* color of saturated particle */
#define PARTICLE_EMIN 10.0          /* energy of particle with coolest color */
#define PARTICLE_EMAX 60000.0        /* energy of particle with hottest color */
#define HUE_TYPE0 320.0      /* hue of particles of type 0 */
#define HUE_TYPE1 60.0       /* hue of particles of type 1 */
#define HUE_TYPE2 320.0      /* hue of particles of type 2 */
#define HUE_TYPE3 260.0      /* hue of particles of type 3 */
...
#define RESAMPLE_Y 0         /* set to 1 to resample y coordinate of moved particles (for shock waves) */
#define NTRIALS 2000         /* number of trials when resampling */
#define OBSTACLE_RADIUS 0.05  /* radius of obstacle for circle boundary conditions */
#define FUNNEL_WIDTH  0.25   /* funnel width for funnel boundary conditions */
#define OBSTACLE_XMIN 0.0    /* initial position of obstacle */
#define OBSTACLE_XMAX 3.0    /* final position of obstacle */
#define RECORD_PRESSURES 0   /* set to 1 to record pressures on obstacle */
...
#define TRACER_PARTICLE 1   /* set to 1 to have a tracer particle */
#define N_TRACER_PARTICLES 1    /* number of tracer particles */
#define TRAJECTORY_LENGTH 5000    /* length of recorded trajectory */
#define TRACER_LUM_FACTOR 1.0     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
#define TRAJECTORY_WIDTH 3        /* width of tracer particle trajectory */
...
### 03 November 2024 - Pulsing sources on the vertices of a dodecahedron ###
...
#define CIRCLE_PATTERN 30   /* pattern of circles or polygons, see list in global_pdes.c */
...
### 02 November 2024 - A Lorentz gas with denser obstacles ###
...
#define N_TRACER_PARTICLES 500    /* number of tracer particles */
#define TRAJECTORY_LENGTH 5000    /* length of recorded trajectory */
#define TRACER_LUM_FACTOR 70.0     /* controls luminosity decrease of trajectories with time */
#define TRACER_PARTICLE_MASS 4.0  /* relative mass of tracer particle */
#define TRAJECTORY_WIDTH 3        /* width of tracer particle trajectory */
...
### 01 November 2024 - Exciting rotating waves in a circle with sources of different frequency ###
...
```
    ...
    for (source = 0; source < N_SOURCES; source++)
    {
        angle = APOLY*PID + 2.0*(double)source*DPI/(double)NPOLY;
        ...
        source_shift[source] = 0;
        if ((ADD_OSCILLATING_SOURCE)&&(i%(OSCILLATING_SOURCE_PERIOD - 5*source) == source_shift[source]))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
            add_circular_wave(-sign[source]*INITIAL_AMP, wave_source_x[source], wave_source_y[source], phi, psi, xy_in);
        }
...
#define MU_B 1.0            /* parameter controlling the dimensions of domain */
#define NPOLY 6             /* number of sides of polygon */
#define APOLY 0.164         /* angle by which to turn polygon, in units of Pi/2 */ 
#define MDEPTH 6            /* depth of computation of Menger gasket */
#define MRATIO 3            /* ratio defining Menger gasket */
#define MANDELLEVEL 1000    /* iteration level for Mandelbrot set */
#define MANDELLIMIT 10.0    /* limit value for approximation of Mandelbrot set */
...
#define INITIAL_AMP 1.35            /* amplitude of initial condition */
#define INITIAL_VARIANCE 0.00001    /* variance of initial condition */
#define INITIAL_WAVELENGTH  0.025   /* wavelength of initial condition */
