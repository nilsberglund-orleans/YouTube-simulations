...
### 31 March 2025 - A Kuramoto model of coupled phase oscillators with stronger noise ###
...
#define PHISHIFT 180.0    /* shift of phi in 2D plot (in degrees) */
...
### 30 March 2025 - Charged particles bouncing in a box without gravity ###
...
### 29 March 2025 - Waves in connected Poisson disc cavities ###
...
```
    ...
    wave_source_x[0] = circles[48].xc;
    wave_source_y[0] = circles[48].yc;
...
#define PDISC_FACTOR 2.5    /* controls density of Poisson disc process (default: 3.25) */
#define RANDOM_POLY_ANGLE 1 /* set to 1 to randomize angle of polygons */
#define PDISC_CONNECT_FACTOR 1.4    /* controls which discs are connected for D_CIRCLE_LATTICE_POISSON domain */
...
#define WALL_WIDTH 0.018    /* width of wall separating lenses */
...
### 28 March 2025 - A Kuramoto model of coupled phase oscillators: effect of noise on vorticity ###
...
#define ADD_NOISE 2     /* set to 1 to add noise, set to 2 to add noise in right half */
#define NOISE_INTENSITY 0.25      /* noise intensity */
#define CHANGE_NOISE 0      /* set to 1 to increase noise intensity */
#define NOISE_FACTOR 40.0   /* factor by which to increase noise intensity */
#define NOISE_INITIAL_TIME 100  /* initial time during which noise remains constant */
...
#define VSCALE_AMPLITUDE 0.01      /* additional scaling factor for color scheme P_3D_AMPLITUDE */
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
#define CURL_SCALE 0.0000075   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define SLOPE_SCHROD_LUM 10.0      /* sensitivity of luminosity on module, for color scheme Z_ARGUMENT */
#define MIN_SCHROD_LUM 0.1       /* minimal luminosity in color scheme Z_ARGUMENT*/
#define VSCALE_PRESSURE 2.0      /* additional scaling factor for color scheme Z_EULER_PRESSURE */
...
### 27 March 2025 - Charged particles bouncing in a box at lower gravity ###
...
### 26 March 2025 - Waves of two different frequencies in a honeycomb lattice of connected circles ###
...
```
    ...
    /* add oscillating waves */
    wave_source_x[0] = polyarc[195].xc;
    wave_source_y[0] = polyarc[195].yc;
    wave_source_x[1] = polyarc[207].xc;
    wave_source_y[1] = polyarc[207].yc;
    source_periods[0] = OSCILLATING_SOURCE_PERIOD;
...
#define B_DOMAIN 95         /* choice of domain shape, see list in global_pdes.c */
...
### 25 March 2025 - Vorticity in a Kuramoto model of coupled phase oscillators ###
...
#define K_HARMONIC 1.0  /* spring constant of harmonic potential */
#define K_COULOMB 0.5   /* constant in Coulomb potential */
#define K_KURAMOTO 10.0 /* constant in Kuramoto model */
#define NU_KURAMOTO 0.0 /* viscosity in Kuramoto model */
#define OMEGA_KURAMOTO 0.02  /* frequency in Kuramoto model */
#define V_MAZE 0.4      /* potential in walls of maze */
#define BZQ 0.0008      /* parameter in BZ equation */
...
#define VSCALE_AMPLITUDE 0.01      /* additional scaling factor for color scheme P_3D_AMPLITUDE */
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
#define CURL_SCALE 0.00005   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define SLOPE_SCHROD_LUM 10.0      /* sensitivity of luminosity on module, for color scheme Z_ARGUMENT */
#define MIN_SCHROD_LUM 0.1       /* minimal luminosity in color scheme Z_ARGUMENT*/
#define VSCALE_PRESSURE 2.0      /* additional scaling factor for color scheme Z_EULER_PRESSURE */
...
### 24 March 2025 - Charged particles bouncing in a box ###
...
### 23 March 2025 - Waves of two different frequencies in a hex lattice of connected circles ###
...
```
    ...
    /* add oscillating waves */
    wave_source_x[0] = polyarc[642].xc;
    wave_source_y[0] = polyarc[642].yc;
    wave_source_x[1] = polyarc[785].xc;
    wave_source_y[1] = polyarc[785].yc;
    source_periods[0] = OSCILLATING_SOURCE_PERIOD;
    source_periods[1] = OSCILLATING_SOURCE_PERIOD*10/7;
    for (source = 0; source < N_SOURCES; source++)
    {
        source_shift[source] = 0;
        if ((ADD_OSCILLATING_SOURCE)&&(i%(source_periods[source]) == source_shift[source])&&(i<MAX_PULSING_TIME))
        {
            if (ALTERNATE_OSCILLATING_SOURCE) sign[source] = -sign[source];
...
### 22 March 2025 - Vidéo #1500: A Kuramoto model of coupled phase oscillators ###
...
#define K_HARMONIC 1.0  /* spring constant of harmonic potential */
#define K_COULOMB 0.5   /* constant in Coulomb potential */
#define K_KURAMOTO 0.1 /* constant in Kuramoto model */
#define NU_KURAMOTO 0.0 /* viscosity in Kuramoto model */
#define OMEGA_KURAMOTO 0.02  /* frequency in Kuramoto model */
#define V_MAZE 0.4      /* potential in walls of maze */
#define BZQ 0.0008      /* parameter in BZ equation */
...
#define ADD_NOISE 0     /* set to 1 to add noise, set to 2 to add noise in right half */
#define NOISE_INTENSITY 0.002      /* noise intensity */
#define CHANGE_NOISE 0      /* set to 1 to increase noise intensity */
#define NOISE_FACTOR 40.0   /* factor by which to increase noise intensity */
#define NOISE_INITIAL_TIME 100  /* initial time during which noise remains constant */
...
### 21 March 2025 - Interacting electrons and ions with charge ratio 0.5 ###
...
#define INITIAL_DAMPING 1000.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 5.0      /* damping coefficient for rotation of particles */
#define PARTICLE_MASS 10000.0     /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0     /* mass of particle of radius MU_B */
#define PARTICLE_ADD_MASS 2.0   /* mass of added particles */
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
#define V_INITIAL 0.0        /* initial velocity range */
#define V_INITIAL_ADD 25.0         /* initial velocity range for added particles */
#define OMEGA_INITIAL 100.0        /* initial angular velocity range */
#define VICSEK_VMIN 1.0    /* minimal speed of particles in Vicsek model */
#define VICSEK_VMAX 40.0    /* minimal speed of particles in Vicsek model */
#define COULOMB_LJ_FACTOR 1.0   /* relative intensity of LJ interaction in I_COULOMB_LJ interaction (default: 0.01) */
...
#define CHARGE 1.0       /* charge of particles of first type */
#define CHARGE_B 1.0     /* charge of particles of second type */
#define CHARGE_ADD -0.5  /* charge of added particles */
#define INCREASE_E 0     /* set to 1 to increase electric field */
#define EFIELD_FACTOR 5000000.0    /* factor by which to increase electric field */
#define INCREASE_B 0     /* set to 1 to increase magnetic field */
#define BFIELD_FACTOR 1.0    /* factor by which to increase magnetic field */
...
### 20 March 2025 - A lighthouse beam starting from a 135 degrees vertex in a Tokarsky paper windmill ###
...
### 19 March 2025 - Waves of two different frequencies in a square lattice of connected circles ###
...
```
    ...
    /* add oscillating waves */
    wave_source_x[0] = polyarc[260].xc;
    wave_source_y[0] = polyarc[260].yc;
    wave_source_x[1] = polyarc[460].xc;
    wave_source_y[1] = polyarc[460].yc;
    source_periods[0] = OSCILLATING_SOURCE_PERIOD;
    source_periods[1] = OSCILLATING_SOURCE_PERIOD*10/7;
    for (source = 0; source < N_SOURCES; source++)
    {
...
### 18 March 2025 - Interacting electrons and ions with charge ratio 1 ###
...
#define INITIAL_DAMPING 1000.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 5.0      /* damping coefficient for rotation of particles */
#define PARTICLE_MASS 5000.0     /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0     /* mass of particle of radius MU_B */
#define PARTICLE_ADD_MASS 2.0   /* mass of added particles */
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
...
#define ADD_EFIELD 1     /* set to 1 to add an electric field */
#define EFIELD -200.0       /* value of electric field */
#define EFIELD_Y 0.0     /* value of electric field */
#define ADD_BFIELD 0     /* set to 1 to add a magnetic field */
#define BFIELD 0.0       /* value of magnetic field */
#define CHARGE 0.5       /* charge of particles of first type */
#define CHARGE_B 1.0     /* charge of particles of second type */
#define CHARGE_ADD -0.5  /* charge of added particles */
#define INCREASE_E 0     /* set to 1 to increase electric field */
#define EFIELD_FACTOR 5000000.0    /* factor by which to increase electric field */
...
### 17 March 2025 - A lighthouse beam in a Tokarsky paper windmill ###
...
#define NPART 1         /* number of particles */
#define NPARTMAX 100000	/* maximal number of particles after resampling */
#define TRAJ_LENGTH 90 /* length of trajectory */
#define PLOT_NMAX 60   /* max length on length plot */
#define LMAX 0.01       /* minimal segment length triggering resampling */ 
#define DMIN 0.02       /* minimal distance to boundary for triggering resampling */ 
#define CYCLE 0         /* set to 1 for closed curve (start in all directions) */
#define SHOWTRAILS 0    /* set to 1 to keep trails of the particles */
...
#define LENGTHS_LOG_SCALE 0         /* set to 1 to use log scale for plot of lengths */
#define LENGTH_PLOT_POLAR 0         /* set to 1 to plot lengths in polar coordinates */
#define MIN_ANGLE 135.0          /* range of angles of trajectory */
...
### 16 March 2025 - 3D render of waves in a honeycomb lattice of connected circles ###
...
### 15 March 2025 - Interacting electrons and ions with charge ratio 2 ###
...
### 14 March 2025 - A lighthouse beam starting from an inner vertex of a pentagram ###
...
#define NPOLY 5             /* number of sides of polygon */
#define APOLY 0.2           /* angle by which to turn polygon, in units of Pi/2 */ 
#define LAMBDA_B 0.381966  /* parameter controlling shape of domain (for P_POLYRING) */
#define NPOLY_B 100000           /* number of sides of second polygon */
#define APOLY_B 1.0         /* angle by which to turn second polygon, in units of Pi/2 */ 
#define DRAW_BILLIARD 1     /* set to 1 to draw billiard */
#define DRAW_CONSTRUCTION_LINES 0   /* set to 1 to draw additional construction lines for billiard */
...
#define NPART 1         /* number of particles */
#define NPARTMAX 100000	/* maximal number of particles after resampling */
#define TRAJ_LENGTH 180 /* length of trajectory */
...
#define MAX_ANGLE 216.0         /* range of angles of trajectory */
#define TEST_INITIAL_COND 0     /* set to 1 to allow only initial conditions that pass a test */
...
#define NSTEPS 16900       /* number of frames of movie */
#define TIME 2500         /* time between movie frames, for fluidity of real-time simulation */ 
#define DPHI 0.00001     /* integration step */
#define NVID 150         /* number of iterations between images displayed on screen */
...
### 13 March 2025 - A metamaterial: honeycomb lattice of connected circles (short version) ###
...
#define WALL_WIDTH_RND 1.5  /* proportion of width of width for random arrangements */
#define RADIUS_FACTOR 0.3   /* controls inner radius for C_RING arrangements */
...
### 12 March 2025 - Interacting electrons and ions with charge ratio 5 ###
...
#define ADD_BFIELD 0     /* set to 1 to add a magnetic field */
#define BFIELD 0.0       /* value of magnetic field */
#define CHARGE 0.2      /* charge of particles of first type */
#define CHARGE_B 1.0     /* charge of particles of second type */
#define CHARGE_ADD -1.0   /* charge of added particles */
#define INCREASE_E 0     /* set to 1 to increase electric field */
#define EFIELD_FACTOR 5000000.0    /* factor by which to increase electric field */
...
### 11 March 2025 - A lighthouse beam starting from an inner verex of an eight-pointed star ###
...
#define LAMBDA_B 0.5953157  /* parameter controlling shape of domain (for P_POLYRING) */
#define NPOLY_B 100000           /* number of sides of second polygon */
#define APOLY_B 1.0         /* angle by which to turn second polygon, in units of Pi/2 */ 
#define DRAW_BILLIARD 1     /* set to 1 to draw billiard */
#define DRAW_CONSTRUCTION_LINES 0   /* set to 1 to draw additional construction lines for billiard */
...
#define PLOT_NMAX 250   /* max length on length plot */
#define LMAX 0.01       /* minimal segment length triggering resampling */ 
#define DMIN 0.02       /* minimal distance to boundary for triggering resampling */ 
#define CYCLE 0         /* set to 1 for closed curve (start in all directions) */
#define SHOWTRAILS 0    /* set to 1 to keep trails of the particles */
...
#define LENGTHS_LOG_SCALE 0         /* set to 1 to use log scale for plot of lengths */
#define LENGTH_PLOT_POLAR 0         /* set to 1 to plot lengths in polar coordinates */
#define MIN_ANGLE 45.0          /* range of angles of trajectory */
#define MAX_ANGLE 315.0         /* range of angles of trajectory */
#define TEST_INITIAL_COND 0     /* set to 1 to allow only initial conditions that pass a test */
...
#define NSTEPS 19500       /* number of frames of movie */
#define TIME 2500         /* time between movie frames, for fluidity of real-time simulation */ 
#define DPHI 0.00001     /* integration step */
#define NVID 150         /* number of iterations between images displayed on screen */
...
### 10 March 2025 - Higher frequency waves in a honeycomb lattice of connected circles ###
...
### 09 March 2025 - Deep impact 12: Throwing a heavy particle in a thicker layer of light particles ###
...
#define NSEG 25          /* number of segments of boundary of circles */
#define INITIAL_TIME 1500     /* time after which to start saving frames */
#define OBSTACLE_INITIAL_TIME 0     /* time after which to start moving obstacle */
#define BOUNDARY_WIDTH 1    /* width of particle boundary */
#define LINK_WIDTH 2        /* width of links between particles */
#define CONTAINER_WIDTH 2   /* width of container boundary */
...
#define REPEL_RADIUS 25.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 0.0          /* damping coefficient of particles */
#define INITIAL_DAMPING 200.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 5.0      /* damping coefficient for rotation of particles */
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0     /* mass of particle of radius MU_B */
#define PARTICLE_ADD_MASS 200.0   /* mass of added particles */
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
#define V_INITIAL 0.0        /* initial velocity range */
#define V_INITIAL_ADD 3500.0        /* initial velocity range for added particles */
#define OMEGA_INITIAL 100.0        /* initial angular velocity range */
#define VICSEK_VMIN 1.0    /* minimal speed of particles in Vicsek model */
#define VICSEK_VMAX 40.0    /* minimal speed of particles in Vicsek model */
#define COULOMB_LJ_FACTOR 1.0   /* relative intensity of LJ interaction in I_COULOMB_LJ interaction (default: 0.01) */
...
### 08 March 2025 - A lighthouse beam in a tilable five-pointed star ###
...
#define LAMBDA_B 0.618034  /* parameter controlling shape of domain (for P_POLYRING) */
#define NPOLY_B 100000           /* number of sides of second polygon */
#define APOLY_B 1.0         /* angle by which to turn second polygon, in units of Pi/2 */ 
#define DRAW_BILLIARD 1     /* set to 1 to draw billiard */
#define DRAW_CONSTRUCTION_LINES 0   /* set to 1 to draw additional construction lines for billiard */
...
#define LENGTHS_LOG_SCALE 0         /* set to 1 to use log scale for plot of lengths */
#define LENGTH_PLOT_POLAR 0         /* set to 1 to plot lengths in polar coordinates */
#define MIN_ANGLE 234.0         /* range of angles of trajectory */
#define MAX_ANGLE 306.0         /* range of angles of trajectory */
#define TEST_INITIAL_COND 0     /* set to 1 to allow only initial conditions that pass a test */
...
#define NSTEPS 5900       /* number of frames of movie */
#define TIME 2500         /* time between movie frames, for fluidity of real-time simulation */ 
#define DPHI 0.00001     /* integration step */
#define NVID 150         /* number of iterations between images displayed on screen */
...
### 07 March 2025 - Waves in a honeycomb lattice of connected circles ###
...
#define ACHIRP 0.25        /* acceleration coefficient in chirp */
#define DAMPING 0.0        /* damping of periodic excitation */
#define COURANT 0.0893       /* Courant number */
#define COURANTB 0.025       /* Courant number in medium B */
#define GAMMA 0.0          /* damping factor in wave equation */
#define GAMMAB 0.0         /* damping factor in wave equation */
#define GAMMA_SIDES 1.0e-4      /* damping factor on boundary */
...
#define ADD_OSCILLATING_SOURCE 1        /* set to 1 to add an oscillating wave source */
#define OSCILLATING_SOURCE_PERIOD 28    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 1                     /* number of sources, for option draw_sources */
#define ALTERNATE_SOURCE_PHASES 0       /* set to 1 to alternate initial phases of sources */
#define MAX_PULSING_TIME 1500            /* max time for adding pulses */
...
#define NSTEPS 2825         /* number of frames of movie */
#define NVID 7              /* number of iterations between images displayed on screen */
#define NSEG 1000           /* number of segments of boundary */
#define INITIAL_TIME 0      /* time after which to start saving frames */
#define BOUNDARY_WIDTH 2    /* width of billiard boundary */
...
### 06 March 2025 - Deep impact 11: Throwing 100 times heavier particles into a sea of light particles ###
...
#define ADD_REGION 0      /* shape of add regions, cf ADD_* in global_ljones */
#define ADD_TIME 0       /* time at which to add first particle */
#define ADD_PERIOD 750     /* time interval between adding further particles */
#define N_ADD_PARTICLES 1  /* number of particles to add */
#define FINAL_NOADD_PERIOD 1000  /* final period where no particles are added */
#define SAFETY_FACTOR 4.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
### 05 March 2025 - A lighthouse beam in a pentagram ###
...
#define PLOT_NMAX 160    /* max length on length plot */
#define LMAX 0.01       /* minimal segment length triggering resampling */ 
#define DMIN 0.02       /* minimal distance to boundary for triggering resampling */ 
#define CYCLE 0         /* set to 1 for closed curve (start in all directions) */
#define SHOWTRAILS 0    /* set to 1 to keep trails of the particles */
...
#define LENGTHS_LOG_SCALE 0         /* set to 1 to use log scale for plot of lengths */
#define LENGTH_PLOT_POLAR 0         /* set to 1 to plot lengths in polar coordinates */
#define MIN_ANGLE 252.0         /* range of angles of trajectory */
#define MAX_ANGLE 288.0         /* range of angles of trajectory */
#define TEST_INITIAL_COND 0     /* set to 1 to allow only initial conditions that pass a test */
...
### 04 March 2025 - Wave in a circle lattice with more random channel width ###
...
#define LAMBDA 1.25	    /* parameter controlling the dimensions of domain */
#define MU 0.125             /* parameter controlling the dimensions of domain */
#define MU_B 1.0            /* parameter controlling the dimensions of domain */
#define NPOLY 6             /* number of sides of polygon */
#define APOLY 0.0           /* angle by which to turn polygon, in units of Pi/2 */ 
#define MDEPTH 6            /* depth of computation of Menger gasket */
...
#define MANDELLIMIT 10.0    /* limit value for approximation of Mandelbrot set */
#define FOCI 1              /* set to 1 to draw focal points of ellipse */
#define NGRIDX 11           /* number of grid point for grid of disks */
...
### 03 March 2025 - Deep impact 10: Throwing 20 times heavier particles into a sea of light particles ###
...
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0     /* mass of particle of radius MU_B */
#define PARTICLE_ADD_MASS 40.0   /* mass of added particles */
#define PARTICLE_INERTIA_MOMENT 0.5     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.5     /* moment of inertia of second type of particle */
#define V_INITIAL 0.0        /* initial velocity range */
#define V_INITIAL_ADD 750.0        /* initial velocity range for added particles */
#define OMEGA_INITIAL 100.0        /* initial angular velocity range */
#define VICSEK_VMIN 1.0    /* minimal speed of particles in Vicsek model */
#define VICSEK_VMAX 40.0    /* minimal speed of particles in Vicsek model */
#define COULOMB_LJ_FACTOR 1.0   /* relative intensity of LJ interaction in I_COULOMB_LJ interaction (default: 0.01) */
...
### 02 March 2025 - A lighthouse beam in an eight-pointed star with right-angled tips ###
...
#define NPOLY 8             /* number of sides of polygon */
#define APOLY 0.0           /* angle by which to turn polygon, in units of Pi/2 */ 
#define LAMBDA_B 0.76536691  /* parameter controlling shape of domain (for P_POLYRING) */
#define NPOLY_B 100000           /* number of sides of second polygon */
#define APOLY_B 1.0         /* angle by which to turn second polygon, in units of Pi/2 */ 
#define DRAW_BILLIARD 1     /* set to 1 to draw billiard */
#define DRAW_CONSTRUCTION_LINES 0   /* set to 1 to draw additional construction lines for billiard */
...
#define LENGTHS_LOG_SCALE 0         /* set to 1 to use log scale for plot of lengths */
#define LENGTH_PLOT_POLAR 0         /* set to 1 to plot lengths in polar coordinates */
#define MIN_ANGLE 135.5          /* range of angles of trajectory */
#define MAX_ANGLE 180.0         /* range of angles of trajectory */
#define TEST_INITIAL_COND 0     /* set to 1 to allow only initial conditions that pass a test */
...
### 01 March 2025 - 3D render of waves in a circle lattice with random channel width ###
