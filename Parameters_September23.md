...
### 30 September 23 - Waves on a planet with a fractal archipelago, 2D representation ###
...
#define B_DOMAIN 83         /* choice of domain shape, see list in global_pdes.c */
...
### 29 September 23 - How can an Earthquake in Japan cause a tsunami in Chile? ###

**Program:** `wave_sphere.c` 

**Initial condition in function `animation()`:** `init_circular_wave_sphere(-139.6503*PI/180.0, 35.6762*PI/180.0, phi, psi, xy_in, wsphere);`
...
#define ROTATE_VIEW 1       /* set to 1 to rotate position of observer */
#define ROTATE_ANGLE -190.0   /* total angle of rotation during simulation */
...
### 28 September 23 - Lift and drag vs angle of attack for an airfoil in a granular medium ###
...
### 27 September 23 - Waves with dodecahedral symmetry on the sphere, 2D representation ###
...
### 26 September 23 - Does an airfoil in a granular medium experience lift? ###
...
#define MU_B 0.010          /* parameter controlling radius of particles of second type */
#define NPOLY 40            /* number of sides of polygon */
#define APOLY 0.07          /* angle by which to turn polygon, in units of Pi/2 */ 
#define AWEDGE 0.5          /* opening angle of wedge, in units of Pi/2 */ 
#define MDEPTH 4            /* depth of computation of Menger gasket */
#define MRATIO 3            /* ratio defining Menger gasket */
#define MANDELLEVEL 1000    /* iteration level for Mandelbrot set */
...
### 25 September 23 - Simulation of an asteroid impact in the Indian Ocean, 2D representation ###
...
#define REPRESENTATION_3D 1     /* choice of 3D representation */ 
#define PLOT_2D 1               /* switch to 2D representation, equirectangular projection */
#define PHISHIFT 170.0           /* shift of phi in 2D plot (in degrees) */
...
### 23 September 23 - Simulation of an asteroid impact in the Indian Ocean, seen from a circular orbit ###
...
### 22 September 23 - Trying to sort particles by mass in a granular medium flowing around a wedge ###
...
#define INITIAL_DAMPING 5.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 100.0      /* dampint coefficient for rotation of particles */
#define PARTICLE_MASS 25.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 1.0   /* mass of particle of radius MU */
#define PARTICLE_INERTIA_MOMENT 0.2     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.02     /* moment of inertia of second type of particle */
#define V_INITIAL 0.0        /* initial velocity range */
...
### 21 September 23 - Waves with icosahedral symmetry on the sphere, 2D representation ###
...
### 20 September 23 - What will the Earth look like with rising sea levels? ###
...
#define REP_AXO_3D 1        /* linear projection (axonometry) */
#define REP_PROJ_3D 0       /* projection on plane orthogonal to observer line of sight */
...
double w_3d[2] = {0.0, 0.015};
double light[3] = {-0.816496581, 0.40824829, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {-6.0, 8.0, 5.5};    /* location of observer for REP_PROJ_3D representation */ 
int reset_view = 0;         /* switch to reset 3D view parameters (for option ROTATE_VIEW) */
...
double w_3d[2] = {0.0, 0.015};
double light[3] = {-0.816496581, 0.40824829, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {-10.0, 0.0, -5.5};    /* location of observer for REP_PROJ_3D representation */ 
int reset_view = 0;         /* switch to reset 3D view parameters (for option ROTATE_VIEW) */
...
### 19 September 23 - A granular medium with two types of particles: mass ratio 20 ###
...
### 18 September 23 - Simulation of an asteroid impact in the North Pacific Ocean, 2D representation ###

**Program:** `wave_sphere.c` 

**Initial condition in function `animation()`:** `init_circular_wave_sphere(3.0, 0.6, phi, psi, xy_in, wsphere);`
...
double w_3d[2] = {0.0, 0.015};
double light[3] = {0.816496581, -0.40824829, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {-10.0, 0.0, 5.0};    /* location of observer for REP_PROJ_3D representation */ 
int reset_view = 0;         /* switch to reset 3D view parameters (for option ROTATE_VIEW) */
...
### 16 September 23 - Simulation of an asteroid impact in the North Pacific Ocean, seen from a circular orbit ###
...
### 15 September 23 - A granular medium with two types of particles ###
...
### 14 September 23 - Waves with cubic symmetry on a sphere ###
...
### 13 September 23 - Waves on a planet with a fractal continent, 2D representation ###
...
```
    init_circular_wave_sphere(PID, -0.1, phi, psi, xy_in, wsphere);
    add_circular_wave_sphere(-1.0, 3.0*PID, -0.1, phi, psi, xy_in, wsphere);
```
...
#define WINHEIGHT 	1150  /* window height */
#define NX 1920          /* number of grid points on x axis */
#define NY 1190           /* number of grid points on y axis */
...
### 12 September 23 - Dislocation dynamics around a blender in a granular medium ###
...
### 11 September 23 - Simulation of a meteor impact in the South Pacific Ocean, 2D representation ###
...
#define REPRESENTATION_3D 1     /* choice of 3D representation */ 
#define PLOT_2D 1               /* switch to 2D representation, equirectangular projection */
#define PHISHIFT 30.0           /* shift of phi in 2D plot (in degrees) */
...
### 9 September 23 - A blender in a granular medium ###
...
### 8 September 23 - Simulation of a meteor impact in the Atlantic Ocean, 2D representation ###
...
### 7 September 23 - Faraday waves in an elliptical container vibrating at period 1 ###
...
### 6 September 23 - Waves on a planet with a fractal archipelago ###
...
```
    init_circular_wave_sphere(0.25, 0.0, phi, psi, xy_in, wsphere);
    add_circular_wave_sphere(-1.0, 0.25 + PI, 0.0, phi, psi, xy_in, wsphere);
```
...
### 5 September 23 - A rotating triangle in a granular medium: kinetic energy and direction ###
...
### 4 September 23 - Simulation of an asteroid impact in the South Pacific Ocean, viewpoint moving east ###
