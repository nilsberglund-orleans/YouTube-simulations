...
### 31 July 23 - Averaged energy flow through a maze ###

**Program:** `lennarjones.c` 
...
#define INITYMAX 5.0	/* y interval for initial condition */

#define ADDXMIN -1.97
#define ADDXMAX -0.8	/* x interval for adding particles */
#define ADDYMIN 5.1
#define ADDYMAX 8.0	/* y interval for adding particles */
...
#define ERATIO 0.998          /* ratio for time-averagin in P_EMEAN color scheme */

/* Color schemes */

#define COLOR_PALETTE 13     /* Color palette, see list in global_ljones.c  */
#define COLOR_PALETTE_EKIN 13   /* Color palette for kinetic energy */
...
#define N_ADD_PARTICLES 10  /* number of particles to add */
...
#define LIMIT_ENERGY 1      /* set to 1 to limit energy, when there is no thermostat */

```

### 29 July 23 - Faraday waves with heptagonal symmetry ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_circular_vibration(0.0, 0.0, 0.015, LAMBDA, 0.001, 0.1, 7.0, SWATER_MIN_HEIGHT, phi, xy_in);`
...
### 28 July 23 - A linear wave hitting a diffraction grating 3: large angle ###
...
#define OSCIL_LEFT_YSHIFT 100.0   /* y-dependence of left oscillation (for non-horizontal waves) */
...
### 27 July 23 - Phonons in a flowing granular material ###
...
#define PARTICLE_HUE_MIN 359.0      /* color of original particle */
#define PARTICLE_HUE_MAX 0.0        /* color of saturated particle */
#define PARTICLE_EMAX 9000.0        /* energy of particle with hottest color */
#define HUE_TYPE0 60.0     /* hue of particles of type 0 */
#define HUE_TYPE1 280.0      /* hue of particles of type 1 */
#define HUE_TYPE2 140.0      /* hue of particles of type 2 */
#define HUE_TYPE3 200.0     /* hue of particles of type 3 */
...
#define KSPRING_BOUNDARY 1.0e7    /* confining harmonic potential outside simulation region */
#define KSPRING_OBSTACLE 1.0e11    /* harmonic potential of obstacles */
#define NBH_DIST_FACTOR 2.8       /* radius in which to count neighbours */
...
### 26 July 23 - Faraday waves in a shallow water "resonator" ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_circular_vibration(0.0, 0.0, 0.025, LAMBDA, 0.001, 0.1, 6.0, SWATER_MIN_HEIGHT, phi, xy_in);`
...
### 25 July 23 - A linear wave hitting a diffraction grating 2: slightly larger angle ###
...
### 24 July 23 - Beyond the jamming transition: Phonons in a granular material ###
...
#define N_PARTICLE_COLORS 200   /* number of colors for P_NUMBER color scheme */
#define INITIAL_POS_TYPE 0      /* type of initial position dependence */
#define ERATIO 0.99          /* ratio for time-averagin in P_EMEAN color scheme */
...
### 22 July 23 - A linear wave hitting a diffraction grating ###
...
#define KAPPA_SIDES 5.0e-4  /* "elasticity" term on absorbing boundary */
#define KAPPA_TOPBOT 0.0    /* "elasticity" term on absorbing boundary */
#define OSCIL_LEFT_YSHIFT 10.0   /* y-dependence of left oscillation (for non-horizontal waves) */
/* The Courant number is given by c*DT/DX, where DT is the time step and DX the lattice spacing */
/* The physical damping coefficient is given by GAMMA/(DT)^2 */
/* Increasing COURANT speeds up the simulation, but decreases accuracy */
/* For similar wave forms, COURANT^2*GAMMA should be kept constant */
...
### 21 July 23 - A tsunami with improved boundary conditions ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_linear_wave(-1.0, 0.01, 5.0e-8, 0.25, SWATER_MIN_HEIGHT, phi, xy_in);`
...
### 20 July 23 - A denser granular material with square-symmetric interaction flowing around a disc ###
...
### 19 July 23 - 3D render of a diffraction grating ###
...
### 18 July 23 - A granular material with square-symmetric interaction flowing around a disc ###
...
#define MANDELLIMIT 10.0    /* limit value for approximation of Mandelbrot set */
#define FOCI 1              /* set to 1 to draw focal points of ellipse */
#define NGRIDX 111           /* number of grid point for grid of disks */
#define NGRIDY 56           /* number of grid point for grid of disks */
#define EHRENFEST_RADIUS 0.9    /* radius of container for Ehrenfest urn configuration */
#define EHRENFEST_WIDTH 0.035     /* width of tube for Ehrenfest urn configuration */
#define TWO_CIRCLES_RADIUS_RATIO 0.8    /* ratio of radii for S_TWO_CIRCLES_EXT segment configuration */
#define DAM_WIDTH 0.05       /* width of dam for S_DAM segment configuration */
...
### 17 July 23 - A tsunami in shallower water ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_linear_wave(-1.0, 0.01, 1.0e-7, 0.25, SWATER_MIN_HEIGHT, phi, xy_in);`
...
#define ADD_CORIOLIS_FORCE 0    /* set to 1 to add Coriolis force (quasigeostrophic Euler equations) */
#define VARIABLE_DEPTH 1    /* set to 1 for variable depth in shallow water equation */
#define SWATER_DEPTH 3      /* variable depth in shallow water equation */
...
#define ADD_HEIGHT_CONSTANT -2.0   /* constant added to wave height */
#define DRAW_DEPTH 1            /* set to 1 to draw water depth */
#define DEPTH_SCALE 1.5         /* vertical scaling of depth plot */
#define DEPTH_SHIFT -0.015      /* vertical shift of depth plot */
...
#define PRESSURE_SHIFT 10.0        /* shift for color scheme Z_EULER_PRESSURE */
#define PRESSURE_LOG_SHIFT -2.5     /* shift for color scheme Z_EULER_PRESSURE */
#define VSCALE_WATER_HEIGHT 0.8     /* vertical scaling of water height */
...
### 15 July 23 - Who is the winner? Lennard-Jones particles bouncing in a maze, with gravity ###
...
#define KREPEL 0.5          /* constant in repelling force between particles */
#define EQUILIBRIUM_DIST 3.5    /* Lennard-Jones equilibrium distance */
#define EQUILIBRIUM_DIST_B 9.0  /* Lennard-Jones equilibrium distance for second type of particle */
#define REPEL_RADIUS 15.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 3.0          /* damping coefficient of particles */
#define OMEGA_INITIAL 10.0        /* initial angular velocity range */
#define INITIAL_DAMPING 5.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 100.0      /* dampint coefficient for rotation of particles */
#define PARTICLE_MASS 2.5    /* mass of particle of radius MU */
...
### 14 July 23 - Why tsunamis are so dangerous ###
...
#define SWATER_MIN_HEIGHT 2.0      /* min height of initial condition for shallow water equation */
#define DEPTH_FACTOR 0.006        /* proportion of min height in variable depth */
#define TANH_FACTOR 1.0         /* steepness of variable depth */
...
### 13 July 23 - A granular material with pentagon-symmetric interaction flowing around a disc ###
...
### 12 July 23 - Classics revisited: A diffraction grating ###
...
### 11 July 23 - Heavier particles solving a larger maze filled with lighter particles ###
...
#define ADD_TIME 0       /* time at which to add first particle */
#define ADD_PERIOD 10       /* time interval between adding further particles */
#define N_ADD_PARTICLES 15  /* number of particles to add */
#define FINAL_NOADD_PERIOD 0  /* final period where no particles are added */
#define SAFETY_FACTOR 2.0  /* no particles are added at distance less than MU*SAFETY_FACTOR of other particles */
...
### 10 July 23 - Asymmetric shallow waves in an annulus ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_linear_blob(0.0, -0.75, 0.025, 0.0, 0.001, 0.25, 0.5, SWATER_MIN_HEIGHT, phi, xy_in);`
...
### 9 July 23 - Bloopers 11: Jumpy particles in a maze ###
...
#define ADDXMAX -0.8	/* x interval for adding particles */
#define ADDYMIN 3.1
#define ADDYMAX 6.0	/* y interval for adding particles */
...
#define PARTICLE_EMAX 500.0         /* energy of particle with hottest color */
#define HUE_TYPE0 60.0     /* hue of particles of type 0 */
#define HUE_TYPE1 250.0      /* hue of particles of type 1 */
#define HUE_TYPE2 140.0      /* hue of particles of type 2 */
#define HUE_TYPE3 200.0     /* hue of particles of type 3 */
...
#define EQUILIBRIUM_DIST_B 5.0  /* Lennard-Jones equilibrium distance for second type of particle */
#define REPEL_RADIUS 15.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 120.0          /* damping coefficient of particles */
#define OMEGA_INITIAL 10.0        /* initial angular velocity range */
#define INITIAL_DAMPING 5.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 100.0      /* dampint coefficient for rotation of particles */
#define PARTICLE_MASS 1.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 0.4   /* mass of particle of radius MU */
#define PARTICLE_INERTIA_MOMENT 0.2     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.02     /* moment of inertia of second type of particle */
#define V_INITIAL 0.0        /* initial velocity range */
#define OMEGA_INITIAL 10.0        /* initial angular velocity range */
...
### 7 July 23 - 3D render of a branched flow in a Poisson point process potential ###
...
### 6 July 23 - A granular material flowing around a disc ###
...
### 5 July 23 - Shallow waves in an annulus ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_linear_wave(0.0, 0.025, 0.0008, 0.25, SWATER_MIN_HEIGHT, phi, xy_in);`
...
### 4 July 23 - Phase space representation of the billiard in a hexagon with convex and concave curved sides ###

**Program:** `billiard_phase_space.c` 

**Initial condition in function `animation()`:** `lyap_exponents[i] = draw_phase_portrait(6, 20, 200, 20, 0.3);`
...
### 3 July 23 - Heavier particles solving a maze filled with lighter particles ###
...
### 1 July 23 - A branched flow in a Poisson point process potential ###
