...
### 31 October 2024 - Pulsing sources on an icosahedron with large obstacles ###
...
### 29 October 2024 - Blue waves in a cardioid ###
...
#define VSCALE_AMPLITUDE 0.15    /* additional scaling factor for wave amplitude */
...
### 28 October 2024 - Viewer request: Simulation of an asteroid impact in the North Sea ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_expanding_blob_sphere(0, (187.0/180.0)*PI, (148.0/180.0)*PI, 0.75, 0.04, 0.075, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);` 
...
double w_3d[2] = {0.0, 0.015};
double light[3] = {-0.816496581, 0.40824829, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {-6.0, 0.0, 4.5};    /* location of observer for REP_PROJ_3D representation */ 
int reset_view = 0;         /* switch to reset 3D view parameters (for option ROTATE_VIEW) */
...
### 27 October 2024 - Frictionless superballs bouncing in a box without gravity ###
...
### 26 October 2024 - Creating rotating waves with six synchronized sources in angled secondary cavities ###
...
### 25 October 2024 - Pulsing sources on an icosahedron ###
...
### 24 October 2024 - Frictionless superballs bouncing in a box, with gravity ###
...
### 23 October 2024 - Creating rotating waves with eight angled secondary cavities ###
...
### 22 October 2024 - Pulsing sources of higher frequency on a dodecahedron ###
...
```
    ...
    for (j=0; j<3; j++)
    {
        ...
        wave_source_x[4*j] = (double)j*DPI/3.0;
        wave_source_y[4*j] = PID - theta;
        wave_source_x[4*j+1] = (double)j*DPI/3.0 + PI/3.0;
        wave_source_y[4*j+1] = theta - PID;
        ...
        wave_source_x[4*j+2] = (double)j*DPI/3.0;
        wave_source_y[4*j+2] = PID - theta;
        wave_source_x[4*j+3] = (double)j*DPI/3.0 + PI/3.0;
        wave_source_y[4*j+3] = theta - PID;
    }
...
#define SCALE 0          /* set to 1 to adjust color scheme to variance of field */
#define SLOPE 1.0        /* sensitivity of color on wave amplitude */
#define VSCALE_AMPLITUDE 0.35  /* additional scaling factor for color scheme P_3D_AMPLITUDE */
#define VSHIFT_AMPLITUDE 0.0   /* additional shift for wave amplitude */
#define VSCALE_ENERGY 5.0     /* additional scaling factor for color scheme P_3D_ENERGY */
#define PHASE_FACTOR 20.0      /* factor in computation of phase in color scheme P_3D_PHASE */
#define PHASE_SHIFT 0.0      /* shift of phase in color scheme P_3D_PHASE */
...
#define RMIN 0.1               /* min value of radial component */
#define Z_SCALING_FACTOR 0.8   /* overall scaling factor of z axis for REP_PROJ_3D representation */
#define XY_SCALING_FACTOR 2.2   /* overall scaling factor for on-screen (x,y) coordinates after projection */
#define ZMAX_FACTOR 1.0         /* max value of z coordinate for REP_PROJ_3D representation */
#define XSHIFT_3D 0.0           /* overall x shift for REP_PROJ_3D representation */
...
### 21 October 2024 - Winnowing with trajectories ###
...
### 20 October 2024 - Creating rotating waves with three angled secondary cavities ###
...
### 19 October 2024 - Pulsing sources on a dodecahedron ###
...
### 18 October 2024 - Trajectories in a mass spectrometer ###
...
### 17 October 2024 - Creating rotating waves with fifteen angled secondary cavities ###
...
#define MU 0.18             /* parameter controlling the dimensions of domain */
#define MU_B 1.0            /* parameter controlling the dimensions of domain */
#define NPOLY 15            /* number of sides of polygon */
#define APOLY 0.0           /* angle by which to turn polygon, in units of Pi/2 */ 
#define MDEPTH 6            /* depth of computation of Menger gasket */
#define MRATIO 3            /* ratio defining Menger gasket */
#define MANDELLEVEL 1000    /* iteration level for Mandelbrot set */
...
#define OSCILLATING_SOURCE_PERIOD 16    /* period of oscillating source */
#define ALTERNATE_OSCILLATING_SOURCE 1  /* set to 1 to alternate sign of oscillating source */
#define N_SOURCES 15                    /* number of sources, for option draw_sources */
#define ALTERNATE_SOURCE_PHASES 0       /* set to 1 to alternate initial phases of sources */
...
### 16 October 2024 - Simulation of an asteroid impact between Ireland and Newfoundland ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_expanding_blob_sphere(0, (220.0/180.0)*PI, (140.0/180.0)*PI, 1.0, 0.075, 0.1, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);` 
...
double w_3d[2] = {0.0, 0.015};
double light[3] = {-0.816496581, 0.40824829, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {5.0, -2.0, 3.5};    /* location of observer for REP_PROJ_3D representation */ 
int reset_view = 0;         /* switch to reset 3D view parameters (for option ROTATE_VIEW) */
...
### 15 October 2024 - Winnowing 3: Throwing the particles from the ground ###
...
### 14 October 2024 - Creating rotating waves with ten angled secondary cavities ###
...
### 13 October 2024 - Viewer request: Simulation of an asteroid impact off the coast of California ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_expanding_blob_sphere(0, (323.4/180.0)*PI, (124.0/180.0)*PI, 1.0, 0.075, 0.1, SWATER_MIN_HEIGHT, phi, xy_in, wsphere);` 
