...
### 30 April 2025 - A Kuramoto model on the sphere with stronger noise ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_onefield_random(1, 0.0, 0.4, phi, xy_in, wsphere);` 
...
#define RDE_EQUATION 91  /* choice of reaction term, see list in global_3d.c */
...
#define ZPLOT 251     /* z coordinate in 3D plot */
...
#define CURL_SCALE 0.000001   /* scaling factor for curl representation */
...
#define RSCALE 0.0              /* scaling factor of radial component */
...
### 29 April 2025 - Waves in a maze of connected circles ###
...
```
    ...
    wave_source_x[0] = circles[0].xc;
    wave_source_y[0] = circles[0].yc;
...
#define B_DOMAIN 933        /* choice of domain shape, see list in global_pdes.c */
...
#define MAX_PULSING_TIME 7000           /* max time for adding pulses */
...
### 28 April 2025 - Formation of polar diatomic molecules, with more particles ###
...
#define RD_INITIAL_COND 72        /* initial condition of particles */
#define REACTION_DIST 1.7         /* maximal distance for reaction to occur */
...
### 27 April 2025 - A Kuramoto model on the sphere with noise ###
...
#define ADD_NOISE 1     /* set to 1 to add noise, set to 2 to add noise in right half */
#define NOISE_INTENSITY 0.05      /* noise intensity */
#define CHANGE_NOISE 0      /* set to 1 to increase noise intensity */
#define NOISE_FACTOR 40.0   /* factor by which to increase noise intensity */
#define NOISE_INITIAL_TIME 100  /* initial time during which noise remains constant */
...
### 26 April 2025 - Waves of two different frequencies in a star rhombic lattice ###
...
```
    ...
    /* add oscillating waves */
    wave_source_x[0] = polyarc[432].xc;
    wave_source_y[0] = polyarc[432].yc;
    source_periods[0] = OSCILLATING_SOURCE_PERIOD;
    source_amp[0] = INITIAL_AMP;
    wave_source_x[1] = polyarc[465].xc;
    wave_source_y[1] = polyarc[465].yc;
    source_periods[1] = OSCILLATING_SOURCE_PERIOD/4;
...
### 25 April 2025 - Formation of polar diatomic molecules, with a weaker Coulomb interaction ###
...
#define RD_TYPES 2                /* number of types in reaction-diffusion equation */
#define RD_INITIAL_COND 72        /* initial condition of particles */
#define REACTION_DIST 1.65        /* maximal distance for reaction to occur */
#define REACTION_PROB 1.0         /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.0     /* probability controlling dissociation reaction */ 
#define KILLING_PROB 0.0015       /* probability of enzymes being killed */
#define DELTAMAX 0.1              /* max orientation difference for pairing polygons */
...
### 24 April 2025 - Vorticity in a Kuramoto model on the sphere with a cubic projection simulation grid ###
...
### 23 April 2025 - Two wave sources in a star rhombic lattice ###
...
```
    ...
    /* add oscillating waves */
    wave_source_x[0] = polyarc[410].xc;
    wave_source_y[0] = polyarc[410].yc;
    source_periods[0] = OSCILLATING_SOURCE_PERIOD;
    source_amp[0] = INITIAL_AMP;
    wave_source_x[1] = polyarc[430].xc;
    wave_source_y[1] = polyarc[430].yc;
    source_periods[1] = OSCILLATING_SOURCE_PERIOD;
...
#define PHASE_SHIFT 0.0      /* shift of phase in color scheme P_3D_PHASE */
#define ATTENUATION 0.0   /* exponential attenuation coefficient of contrast with time */
#define VSHIFT_AMPLITUDE -0.3    /* additional shift for wave amplitude */
#define VSCALE_AMPLITUDE 0.2    /* additional scaling factor for wave amplitude */
#define E_SCALE 10.0       /* scaling factor for energy representation */
#define LOG_SCALE 0.75     /* scaling factor for energy log representation */
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
...
### 22 April 2025 - Formation of polar diatomic molecules ###
...
### 21 April 2025 - Psychedelic Easter egg: Kuramoto model on the sphere with a cubic projection simulation grid ###
...
### 20 April 2025 - 3D representation of waves in a star rhombic lattice ###
...
### 19 April 2025 - Clustering charged particles, with reduced oscillations ###
...
### 18 April 2025 - Vorticity in a Kuramoto model on the sphere with a modified simulation grid ###
...
#define RSCALE 0.075            /* scaling factor of radial component */
#define RSCALE_B 1.00           /* experimental, additional radial scaling factor in ij_to_sphere */
#define RSHIFT 0.0              /* shift in radial component */
#define RMAX 10.0               /* max value of radial component */
#define RMIN 0.0                /* min value of radial component */
...
### 17 April 2025 - Waves in a star rhombic lattice ###
...
### 16 April 2025 - Bloopers 22: Clustering charged particles ###
...
#define INITIAL_DAMPING 0.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 5.0      /* damping coefficient for rotation of particles */
#define DAMPING_PAIRS 1.05    /* damping between paired particles */
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 2.0     /* mass of particle of radius MU_B */
#define PARTICLE_ADD_MASS 2.0   /* mass of added particles */
#define PARTICLE_INERTIA_MOMENT 0.1     /* moment of inertia of particle */
...
### 15 April 2025 - Kuramoto model on the sphere with a modified simulation grid ###
...
### 14 April 2025 - Waves in a refracting lattice of connected discs ###
...
### 13 April 2025 - Charged particles reacting to form molecules ###
...
### 12 April 2025 - Bloopers 21: Boundary condition issues for the Kuramoto model on the sphere ###
...
### 11 April 2025 - Standing waves in a square lattice of discs with next-to-nearest neighbor connections ###
...
#define B_DOMAIN 932         /* choice of domain shape, see list in global_pdes.c */
...
### 10 April 2025 - Mixing charged particles with increasing interaction ###
...
### 09 April 2025 - 3D rendering of a Kuramoto model of coupled phase oscillators with noise ###
...
### 08 April 2025 - Waves in a square lattice of discs with next-to-nearest neighbor connections ###
...
#define PHASE_SHIFT 0.0      /* shift of phase in color scheme P_3D_PHASE */
#define ATTENUATION 0.0   /* exponential attenuation coefficient of contrast with time */
#define VSHIFT_AMPLITUDE -0.6    /* additional shift for wave amplitude */
#define VSCALE_AMPLITUDE 0.2    /* additional scaling factor for wave amplitude */
#define E_SCALE 30.0       /* scaling factor for energy representation */
#define LOG_SCALE 0.75     /* scaling factor for energy log representation */
#define LOG_SHIFT 0.75     /* shift of colors on log scale */
...
### 07 April 2025 - Mixing charged particles ###
...
### 06 April 2025 - 3D rendering of a Kuramoto model of coupled phase oscillators ###
...
### 05 April 2025 - Waves in connected Poisson disc cavities - 3D rendering ###
...
### 04 April 2025 - Force and charge density of charged particles bouncing in a box ###
...
### 03 April 2025 - A Kuramoto model of coupled phase oscillators (short version) ###
...
### 02 April 2025 - Two sources of different frequencies in connected Poisson disc cavities ###
...
### 01 April 2025 - Can one maliciously add oneself to a group chat? ###
...
#define B_DOMAIN 531         /* choice of domain shape, see list in global_pdes.c */
