...
### 31 March 23 - Periodic oscillations in a modified Brusselator ###
...
#define HUE_TYPE0 200.0      /* hue of particles of type 0 */
#define HUE_TYPE1 270.0      /* hue of particles of type 1 */
#define HUE_TYPE2 70.0       /* hue of particles of type 2 */
#define HUE_TYPE3 160.0      /* hue of particles of type 3 */
...
### 30 March 23 - A Tesla valve with a faster flow ###
...
### 29 March 23 - A phased array (short version) ###
...
#define ALTERNATE_OSCILLATING_SOURCE 2  /* set to 1 to alternate sign of oscillating source */
...
### 28 March 23 - A first attempt at simulating the Belousov-Zhabotinsky reaction (Oregonator model) ###
...
#define REACTION_PROB 0.5       /* probability controlling reaction term */ 
#define DISSOCIATION_PROB 0.01  /* probability controlling dissociation reaction */ 
#define CENTER_COLLIDED_PARTICLES 0  /* set to 1 to recenter particles upon reaction (may interfere with thermostat) */
#define EXOTHERMIC 0            /* set to 1 to make reaction exo/endothermic */
#define DELTA_EKIN 500.0       /* change of kinetic energy in reaction */
#define COLLISION_TIME 25       /* time during which collisions are shown */
...
### 27 March 23 - 3D rendering of a phased array ###
...
### 26 March 23 - A Tesla valve with a slower flow ###
