...
### 11 April 2026 - Particles on a rotating sphere ###
...
#define PDISC_DISTANCE 7.5  /* minimal distance in Poisson disc process, controls density of particles */
...
#define N_TRACER_PARTICLES 5000    /* number of tracer particles */
...
### 10 April 2026 - Time-slice representation of honeycombs in the Gray-Scott model seen from below ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_gs_blob(0.0, 0.0, 0.0, 1.0, 0.05, phi, xy_in, wsphere);` 
...
#define RDE_EQUATION 12  /* choice of reaction term, see list in global_3d.c */
...
/* Gray-Scott model */
#define A_GS 0.0255      /* coupling constant in Gray-Scott model */
#define B_GS 0.052       /* coupling constant in Gray-Scott model */
...
#define OPTIMIZE_GRID 0     /* set to 1 to optimize grid by evolving grid points */
...
#define VSCALE_TIMESLICE 1.4      /* additional scaling factor for color scheme Z_TIMESLICE */
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
...
#define Z_SCALING_FACTOR 0.7   /* overall scaling factor of z axis for REP_PROJ_3D representation */
...
### 09 April 2026 - Separating rightons and leftons on a sphere using an electric field ###
...
double light[3] = {-0.40824829, 0.816496581, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {-3.0, 2.0, -3.5};    /* location of observer for REP_PROJ_3D representation */ 
...
### 08 April 2026 - Time-slice representation of honeycombs in the Gray-Scott model ###
...
### 07 April 2026 - More rightons and leftons on a sphere in a stronger electric field ###
...
### 06 April 2026 - Time-slice representation of meanders in the Gray-Scott model ###
...
/* Gray-Scott model */
#define A_GS 0.0255      /* coupling constant in Gray-Scott model */
#define B_GS 0.056       /* coupling constant in Gray-Scott model */
#define D_GSU 1.0        /* u diffusion in Gray-Scott model */
#define D_GSV 2.0        /* v diffusion in Gray-Scott model */
#define GS_RSCALE 0.1    /* scaling factor for reaction term of Gray-Scott model */
#define GS_DSCALE 0.1    /* scaling factor for diffusion term of Gray-Scott model */
...
#define VSHIFT_AMPLITUDE -0.4    /* additional shift for wave amplitude */
#define VSCALE_AMPLITUDE 3.5      /* additional scaling factor for color scheme P_3D_AMPLITUDE */
#define VSCALE_TIMESLICE 1.2      /* additional scaling factor for color scheme Z_TIMESLICE */
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
#define CURL_SCALE 1.25   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
#define SLOPE_SCHROD_LUM 10.0      /* sensitivity of luminosity on module, for color scheme Z_ARGUMENT */
...
### 05 April 2026 - Rightons and leftons on a sphere in an electric Field ###
...
### 04 April 2026 - Time-slice representation of spots in the Gray-Scott model ###
...
#define SLOPE 1.0        /* sensitivity of color on wave amplitude */
#define COLOR_RANGE 1.0    /* max range of color (default: 1.0) */
#define VSHIFT_AMPLITUDE -1.0   /* additional shift for wave amplitude */
#define VSCALE_AMPLITUDE 6.0      /* additional scaling factor for color scheme P_3D_AMPLITUDE */
#define VSCALE_TIMESLICE 1.2      /* additional scaling factor for color scheme Z_TIMESLICE */
#define ATTENUATION 0.0  /* exponential attenuation coefficient of contrast with time */
#define CURL_SCALE 1.25   /* scaling factor for curl representation */
#define RESCALE_COLOR_IN_CENTER 0   /* set to 1 to decrease color intentiy in the center (for wave escaping ring) */
...
### 03 April 2026 - Increasing and decreasing rotating gravity on a sphere ###
...
#define COLOR_BACKGROUND 0  /* set to 1 to color background */
#define BG_COLOR 12         /* type of background coloring, see list in global_ljones.c */
#define BG_COLOR_B 3        /* type of background coloring, see list in global_ljones.c */
#define OBSTACLE_COLOR 0    /* type of obstacle, see OC_ in global_ljones.c */
#define SHADE_BG_COLOR_2D 1 /* set to 1 to shade BG color, for option BG_POTENTIAL */
#define SHADE_SCALE_BG_2D 0.1   /* controls 2D shading */
...
#define SEGMENT_FORCE_EQR 1.0   /* equilibrium distance factor for force from segments (default 1.5) */
#define REPEL_RADIUS 25.0    /* radius in which repelling force acts (in units of particle radius) */
#define DAMPING 75.0          /* damping coefficient of particles */
#define INITIAL_DAMPING 1000.0  /* damping coefficient of particles during initial phase */
#define DAMPING_ROT 0.0      /* damping coefficient for rotation of particles */
#define DAMPING_PAIRS 0.0    /* damping between paired particles */
#define PARTICLE_MASS 2.0    /* mass of particle of radius MU */
#define PARTICLE_MASS_B 20.0     /* mass of particle of radius MU_B */
#define PARTICLE_ADD_MASS 2.0   /* mass of added particles */
#define PARTICLE_ADD_MASS_B 1.0   /* mass of added particles */
#define PARTICLE_INERTIA_MOMENT 0.1     /* moment of inertia of particle */
#define PARTICLE_INERTIA_MOMENT_B 0.1     /* moment of inertia of second type of particle */
...
#define GRAVITY_X 0.0          /* horizontal gravity acting on all particles */
#define CIRCULAR_GRAVITY 0     /* set to 1 to have gravity directed to center */
#define SPHERE_GRAVITY 2       /* set to 1 to have gravity at constant angle wrt sphere */
...
#define ROTATE_VIEW 1       /* set to 1 to rotate position of observer */
#define ROTATE_ANGLE 1200.0   /* total angle of rotation during simulation */
#define VIEWPOINT_TRAJ 1    /* type of viewpoint trajectory */
#define MAX_LATITUDE 45.0   /* maximal latitude for viewpoint trajectory VP_ORBIT2 */

double light[3] = {0.40824829, -0.816496581, 0.40824829};      /* vector of "light" direction for P_3D_ANGLE color scheme */
double observer[3] = {2.0, 0.0, 0.5};    /* location of observer for REP_PROJ_3D representation */ 
...
### 02 April 2026 - Time-slice representation of mazes in the Gray-Scott model ###

**Program:** `rde.c` 

**Initial condition in function `animation()`:** `init_gs_blob(0.0, 0.0, 0.0, 1.0, 0.25, phi, xy_in, wsphere);` 
...
/* Gray-Scott model */
#define A_GS 0.037       /* coupling constant in Gray-Scott model */
#define B_GS 0.06        /* coupling constant in Gray-Scott model */
#define D_GSU 1.0        /* u diffusion in Gray-Scott model */
#define D_GSV 2.0        /* v diffusion in Gray-Scott model */
#define GS_RSCALE 0.1    /* scaling factor for reaction term of Gray-Scott model */
...
#define FLOODING_VSHIFT -10.0    /* controls when wave is considered higher than land */
#define FLOODING_VSHIFT_2D 0.56    /* controls when wave is considered higher than land */
#define TIME_SLICE_THRESHOLD 0.25    /* threshold of field 0 for Z_TIME_SLICE */
...
### 01 April 2026 - Rightons and leftons on a sphere ###
...
**3D part without background color:**
